...
$_QQclXef2a3d277f21696c502d88d66b82bd8a = comdat any
...
@_QQclXef2a3d277f21696c502d88d66b82bd8a = linkonce constant [85 x i8] c"/home/studyztp/experiments/panning/hardware-experiment/nugget-protocol-NPB/FT/ft.f90\00", comdat
...
.lr.ph.preheader.i:                               ; preds = %.lr.ph21.i
  ...
  %min.iters.check = icmp ult i64 %95, 14
...
.lr.ph.preheader.i530:                            ; preds = %.lr.ph21.i526
  ...
  %min.iters.check605 = icmp ult i64 %179, 14
...
omp_collapsed.body.us.preheader:                  ; preds = %omp_collapsed.body.lr.ph
  ...
  %19 = icmp eq i32 %13, 1
  %unroll_iter = and i64 %18, 2147483646
...
omp_collapsed.body.us:                            ; preds = %omp_collapsed.body.us.preheader, %omp.wsloop.region14.omp.wsloop.region16_crit_edge.us
  ...
  %20 = add i32 %omp_collapsed.iv23.us, %11
  %21 = urem i32 %20, %omp_loop.tripcount2
  %22 = udiv i32 %20, %omp_loop.tripcount2
  %23 = add i32 %22, 1
  ...
  %29 = getelementptr { double, double }, ptr %loadgep_6, i64 %28
  %30 = getelementptr { double, double }, ptr %29, i64 %26
  %31 = mul nsw i64 %3, %25
  %32 = mul nsw i64 %16, %27
  %33 = getelementptr { double, double }, ptr %loadgep_8, i64 %32
  %34 = getelementptr { double, double }, ptr %33, i64 %31
  %35 = mul nsw i64 %5, %25
  %36 = mul nsw i64 %17, %27
  %37 = getelementptr double, ptr %loadgep_10, i64 %36
  %38 = getelementptr double, ptr %37, i64 %35
  br i1 %19, label %omp.wsloop.region14.omp.wsloop.region16_crit_edge.us.unr-lcssa, label %omp.wsloop.region15.us

omp.wsloop.region15.us:                           ; preds = %omp_collapsed.body.us, %omp.wsloop.region15.us
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %omp.wsloop.region15.us ], [ 1, %omp_collapsed.body.us ]
  %niter = phi i64 [ %niter.next.1, %omp.wsloop.region15.us ], [ 0, %omp_collapsed.body.us ]
  %39 = add nsw i64 %indvars.iv, -1
  %40 = getelementptr { double, double }, ptr %30, i64 %39
  %41 = getelementptr { double, double }, ptr %34, i64 %39
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %40, i8 0, i64 16, i1 false)
  %42 = getelementptr double, ptr %38, i64 %39
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %41, i8 0, i64 16, i1 false)
  store double 0.000000e+00, ptr %42, align 8, !tbaa !64
  %43 = getelementptr { double, double }, ptr %30, i64 %indvars.iv
  %44 = getelementptr { double, double }, ptr %34, i64 %indvars.iv
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %43, i8 0, i64 16, i1 false)
  %45 = getelementptr double, ptr %38, i64 %indvars.iv
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %44, i8 0, i64 16, i1 false)
  store double 0.000000e+00, ptr %45, align 8, !tbaa !64
...
omp.wsloop.region14.omp.wsloop.region16_crit_edge.us.unr-lcssa: ; preds = %omp.wsloop.region15.us, %omp_collapsed.body.us
  %indvars.iv.unr = phi i64 [ 1, %omp_collapsed.body.us ], [ %indvars.iv.next.1, %omp.wsloop.region15.us ]
...
omp.wsloop.region15.us.epil:                      ; preds = %omp.wsloop.region14.omp.wsloop.region16_crit_edge.us.unr-lcssa
  %46 = add nsw i64 %indvars.iv.unr, -1
  %47 = getelementptr { double, double }, ptr %30, i64 %46
  %48 = getelementptr { double, double }, ptr %34, i64 %46
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %47, i8 0, i64 16, i1 false)
  %49 = getelementptr double, ptr %38, i64 %46
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %48, i8 0, i64 16, i1 false)
  store double 0.000000e+00, ptr %49, align 8, !tbaa !64
...
omp_collapsed.body.us:                            ; preds = %omp_collapsed.body.us.preheader, %omp.wsloop.region14.omp.wsloop.region16_crit_edge.us
  ...
  %20 = urem i32 %19, %omp_loop.tripcount2
  %21 = udiv i32 %19, %omp_loop.tripcount2
  %22 = add i32 %21, 1
...
omp.wsloop.region4:                               ; preds = %omp.wsloop.region4.lr.ph, %omp.wsloop.region4
  ...
  call void @vranlc_(ptr nonnull %4, ptr nonnull %5, ptr nonnull %3, ptr %22) #6
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
define void @setup_() local_unnamed_addr #0 {
  ...
  %1 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX85102b32e0ac3e984da09d954ace518b, i64 66, ptr null, i32 6, ptr nonnull @_QQclXef2a3d277f21696c502d88d66b82bd8a, i32 334)
  %2 = tail call i32 @_FortranAioEndIoStatement(ptr %1)
  store i32 25, ptr @_QMft_dataEniter, align 4, !tbaa !105
  %3 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXc267696b5bcdf54351b18244b9f7fa43, i64 49, ptr null, i32 6, ptr nonnull @_QQclXef2a3d277f21696c502d88d66b82bd8a, i32 338)
  ...
  %8 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXa963f07a6dea1ec01ba1c54badeb65d0, i64 38, ptr null, i32 6, ptr nonnull @_QQclXef2a3d277f21696c502d88d66b82bd8a, i32 339)
  ...
  %12 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXc8c816e7d078dd1ad35ebfc1f2802448, i64 38, ptr null, i32 6, ptr nonnull @_QQclXef2a3d277f21696c502d88d66b82bd8a, i32 340)
  ...
  %16 = tail call ptr @_FortranAioBeginExternalListOutput(i32 6, ptr nonnull @_QQclXef2a3d277f21696c502d88d66b82bd8a, i32 341)
...
omp_collapsed.body.us:                            ; preds = %omp_collapsed.body.us.preheader, %omp.wsloop.region14.omp.wsloop.region16_crit_edge.us
  ...
  %18 = urem i32 %17, %omp_loop.tripcount2
  %19 = udiv i32 %17, %omp_loop.tripcount2
  %20 = add i32 %19, 1
  %21 = add i32 %19, 1024
  %22 = srem i32 %21, 2048
  %23 = add nsw i32 %22, -1024
  %24 = mul nsw i32 %23, %23
  %25 = add nuw i32 %18, 1024
  %26 = srem i32 %25, 2048
...
define void @print_timers_() local_unnamed_addr #0 {
  ...
  %6 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX3888eaff8ece5bfb29b8d7929fca1d13, i64 54, ptr null, i32 6, ptr nonnull @_QQclXef2a3d277f21696c502d88d66b82bd8a, i32 458)
  ...
  %20 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX3888eaff8ece5bfb29b8d7929fca1d13, i64 54, ptr null, i32 6, ptr nonnull @_QQclXef2a3d277f21696c502d88d66b82bd8a, i32 458)
  ...
  %34 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX3888eaff8ece5bfb29b8d7929fca1d13, i64 54, ptr null, i32 6, ptr nonnull @_QQclXef2a3d277f21696c502d88d66b82bd8a, i32 458)
  ...
  %48 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX3888eaff8ece5bfb29b8d7929fca1d13, i64 54, ptr null, i32 6, ptr nonnull @_QQclXef2a3d277f21696c502d88d66b82bd8a, i32 458)
  ...
  %62 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX3888eaff8ece5bfb29b8d7929fca1d13, i64 54, ptr null, i32 6, ptr nonnull @_QQclXef2a3d277f21696c502d88d66b82bd8a, i32 458)
  ...
  %76 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX3888eaff8ece5bfb29b8d7929fca1d13, i64 54, ptr null, i32 6, ptr nonnull @_QQclXef2a3d277f21696c502d88d66b82bd8a, i32 458)
  ...
  %90 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX3888eaff8ece5bfb29b8d7929fca1d13, i64 54, ptr null, i32 6, ptr nonnull @_QQclXef2a3d277f21696c502d88d66b82bd8a, i32 458)
  ...
  %104 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX3888eaff8ece5bfb29b8d7929fca1d13, i64 54, ptr null, i32 6, ptr nonnull @_QQclXef2a3d277f21696c502d88d66b82bd8a, i32 458)
...
omp_collapsed.body:                               ; preds = %omp_collapsed.body.lr.ph, %omp.wsloop.region25
  %25 = phi i32 [ %.pre, %omp_collapsed.body.lr.ph ], [ %58, %omp.wsloop.region25 ]
...
omp.wsloop.region15.us.preheader:                 ; preds = %omp.wsloop.region15.lr.ph
  ...
  %40 = icmp eq i32 %32, 1
  %unroll_iter = and i64 %38, 2147483646
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br label %omp.wsloop.region15.us
...
omp.wsloop.region15.us:                           ; preds = %omp.wsloop.region15.us.preheader, %omp.wsloop.region16.omp.wsloop.region18_crit_edge.us
  ...
  %44 = add nsw i64 %43, -1
  %45 = mul nsw i64 %44, %7
  %46 = getelementptr { double, double }, ptr %37, i64 %45
  %invariant.gep.us = getelementptr { double, double }, ptr %10, i64 %indvars.iv44
  br i1 %40, label %omp.wsloop.region16.omp.wsloop.region18_crit_edge.us.unr-lcssa, label %omp.wsloop.region17.us

omp.wsloop.region17.us:                           ; preds = %omp.wsloop.region15.us, %omp.wsloop.region17.us
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %omp.wsloop.region17.us ], [ 1, %omp.wsloop.region15.us ]
  %niter = phi i64 [ %niter.next.1, %omp.wsloop.region17.us ], [ 0, %omp.wsloop.region15.us ]
  %47 = add nsw i64 %indvars.iv, -1
  %48 = getelementptr { double, double }, ptr %46, i64 %47
  %.unpack32.us = load double, ptr %48, align 8, !tbaa !154
  %.elt33.us = getelementptr inbounds i8, ptr %48, i64 8
  %.unpack34.us = load double, ptr %.elt33.us, align 8, !tbaa !154
  %49 = mul nsw i64 %47, %1
  %gep.us = getelementptr { double, double }, ptr %invariant.gep.us, i64 %49
  %50 = getelementptr i8, ptr %gep.us, i64 -16
  store double %.unpack32.us, ptr %50, align 8, !tbaa !147
  %.repack35.us = getelementptr i8, ptr %gep.us, i64 -8
  store double %.unpack34.us, ptr %.repack35.us, align 8, !tbaa !147
  %51 = getelementptr { double, double }, ptr %46, i64 %indvars.iv
  %.unpack32.us.1 = load double, ptr %51, align 8, !tbaa !154
  %.elt33.us.1 = getelementptr inbounds i8, ptr %51, i64 8
  %.unpack34.us.1 = load double, ptr %.elt33.us.1, align 8, !tbaa !154
  %52 = mul nsw i64 %indvars.iv, %1
  %gep.us.1 = getelementptr { double, double }, ptr %invariant.gep.us, i64 %52
  %53 = getelementptr i8, ptr %gep.us.1, i64 -16
  store double %.unpack32.us.1, ptr %53, align 8, !tbaa !147
  %.repack35.us.1 = getelementptr i8, ptr %gep.us.1, i64 -8
  store double %.unpack34.us.1, ptr %.repack35.us.1, align 8, !tbaa !147
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %omp.wsloop.region16.omp.wsloop.region18_crit_edge.us.unr-lcssa, label %omp.wsloop.region17.us

omp.wsloop.region16.omp.wsloop.region18_crit_edge.us.unr-lcssa: ; preds = %omp.wsloop.region17.us, %omp.wsloop.region15.us
  %indvars.iv.unr = phi i64 [ 1, %omp.wsloop.region15.us ], [ %indvars.iv.next.1, %omp.wsloop.region17.us ]
  br i1 %lcmp.mod.not, label %omp.wsloop.region16.omp.wsloop.region18_crit_edge.us, label %omp.wsloop.region17.us.epil

omp.wsloop.region17.us.epil:                      ; preds = %omp.wsloop.region16.omp.wsloop.region18_crit_edge.us.unr-lcssa
  %54 = add nsw i64 %indvars.iv.unr, -1
  %55 = getelementptr { double, double }, ptr %46, i64 %54
  %.unpack32.us.epil = load double, ptr %55, align 8, !tbaa !154
  %.elt33.us.epil = getelementptr inbounds i8, ptr %55, i64 8
  %.unpack34.us.epil = load double, ptr %.elt33.us.epil, align 8, !tbaa !154
  %56 = mul nsw i64 %54, %1
  %gep.us.epil = getelementptr { double, double }, ptr %invariant.gep.us, i64 %56
  %57 = getelementptr i8, ptr %gep.us.epil, i64 -16
  store double %.unpack32.us.epil, ptr %57, align 8, !tbaa !147
  %.repack35.us.epil = getelementptr i8, ptr %gep.us.epil, i64 -8
  store double %.unpack34.us.epil, ptr %.repack35.us.epil, align 8, !tbaa !147
  br label %omp.wsloop.region16.omp.wsloop.region18_crit_edge.us

omp.wsloop.region16.omp.wsloop.region18_crit_edge.us: ; preds = %omp.wsloop.region16.omp.wsloop.region18_crit_edge.us.unr-lcssa, %omp.wsloop.region17.us.epil
...
omp.wsloop.region19:                              ; preds = %omp.wsloop.region16.omp.wsloop.region18_crit_edge.us, %omp.wsloop.region15.lr.ph, %omp_collapsed.body
  call void @cfftz_(ptr %loadgep_4, ptr %loadgep_6, ptr %loadgep_8, ptr nonnull %10, ptr nonnull %12) #6
  %58 = load i32, ptr @_QMft_dataEfftblock, align 4, !tbaa !150
  %59 = icmp sgt i32 %58, 0
  br i1 %59, label %omp.wsloop.region21.lr.ph, label %omp.wsloop.region25

omp.wsloop.region21.lr.ph:                        ; preds = %omp.wsloop.region19
  %60 = load i32, ptr %loadgep_8, align 4, !tbaa !152
  %61 = icmp sgt i32 %60, 0
  %62 = sext i32 %29 to i64
  %63 = add nsw i64 %62, -1
  %64 = mul nsw i64 %24, %63
  %65 = getelementptr { double, double }, ptr %loadgep_10, i64 %64
  br i1 %61, label %omp.wsloop.region21.us.preheader, label %omp.wsloop.region25

omp.wsloop.region21.us.preheader:                 ; preds = %omp.wsloop.region21.lr.ph
  %66 = zext nneg i32 %60 to i64
  %narrow57 = add nuw i32 %58, 1
  %67 = zext i32 %narrow57 to i64
  %xtraiter58 = and i64 %66, 1
  %68 = icmp eq i32 %60, 1
  %unroll_iter60 = and i64 %66, 2147483646
...
omp.wsloop.region21.us:                           ; preds = %omp.wsloop.region21.us.preheader, %omp.wsloop.region22.omp.wsloop.region24_crit_edge.us
  ...
  %69 = trunc nuw nsw i64 %indvars.iv52 to i32
  %70 = add i32 %30, %69
  %71 = sext i32 %70 to i64
  %72 = add nsw i64 %71, -1
  %73 = mul nsw i64 %72, %5
  %74 = getelementptr { double, double }, ptr %65, i64 %73
  br i1 %68, label %omp.wsloop.region22.omp.wsloop.region24_crit_edge.us.unr-lcssa, label %omp.wsloop.region23.us

omp.wsloop.region23.us:                           ; preds = %omp.wsloop.region21.us, %omp.wsloop.region23.us
  %indvars.iv48 = phi i64 [ %indvars.iv.next49.1, %omp.wsloop.region23.us ], [ 1, %omp.wsloop.region21.us ]
  %niter61 = phi i64 [ %niter61.next.1, %omp.wsloop.region23.us ], [ 0, %omp.wsloop.region21.us ]
  %75 = add nsw i64 %indvars.iv48, -1
  %76 = mul nsw i64 %75, %1
  %gep.us37 = getelementptr { double, double }, ptr %invariant.gep.us38, i64 %76
  %77 = getelementptr i8, ptr %gep.us37, i64 -16
  %.unpack.us = load double, ptr %77, align 8, !tbaa !147
  %.elt28.us = getelementptr i8, ptr %gep.us37, i64 -8
  %.unpack29.us = load double, ptr %.elt28.us, align 8, !tbaa !147
  %78 = getelementptr { double, double }, ptr %74, i64 %75
  store double %.unpack.us, ptr %78, align 8, !tbaa !156
  %.repack30.us = getelementptr inbounds i8, ptr %78, i64 8
  store double %.unpack29.us, ptr %.repack30.us, align 8, !tbaa !156
  %79 = mul nsw i64 %indvars.iv48, %1
  %gep.us37.1 = getelementptr { double, double }, ptr %invariant.gep.us38, i64 %79
  %80 = getelementptr i8, ptr %gep.us37.1, i64 -16
  %.unpack.us.1 = load double, ptr %80, align 8, !tbaa !147
  %.elt28.us.1 = getelementptr i8, ptr %gep.us37.1, i64 -8
  %.unpack29.us.1 = load double, ptr %.elt28.us.1, align 8, !tbaa !147
  %81 = getelementptr { double, double }, ptr %74, i64 %indvars.iv48
  store double %.unpack.us.1, ptr %81, align 8, !tbaa !156
  %.repack30.us.1 = getelementptr inbounds i8, ptr %81, i64 8
  store double %.unpack29.us.1, ptr %.repack30.us.1, align 8, !tbaa !156
  ...
  br i1 %niter61.ncmp.1, label %omp.wsloop.region22.omp.wsloop.region24_crit_edge.us.unr-lcssa, label %omp.wsloop.region23.us

omp.wsloop.region22.omp.wsloop.region24_crit_edge.us.unr-lcssa: ; preds = %omp.wsloop.region23.us, %omp.wsloop.region21.us
  %indvars.iv48.unr = phi i64 [ 1, %omp.wsloop.region21.us ], [ %indvars.iv.next49.1, %omp.wsloop.region23.us ]
  br i1 %lcmp.mod59.not, label %omp.wsloop.region22.omp.wsloop.region24_crit_edge.us, label %omp.wsloop.region23.us.epil

omp.wsloop.region23.us.epil:                      ; preds = %omp.wsloop.region22.omp.wsloop.region24_crit_edge.us.unr-lcssa
  %82 = add nsw i64 %indvars.iv48.unr, -1
  %83 = mul nsw i64 %82, %1
  %gep.us37.epil = getelementptr { double, double }, ptr %invariant.gep.us38, i64 %83
  %84 = getelementptr i8, ptr %gep.us37.epil, i64 -16
  %.unpack.us.epil = load double, ptr %84, align 8, !tbaa !147
  %.elt28.us.epil = getelementptr i8, ptr %gep.us37.epil, i64 -8
  %.unpack29.us.epil = load double, ptr %.elt28.us.epil, align 8, !tbaa !147
  %85 = getelementptr { double, double }, ptr %74, i64 %82
  store double %.unpack.us.epil, ptr %85, align 8, !tbaa !156
  %.repack30.us.epil = getelementptr inbounds i8, ptr %85, i64 8
  store double %.unpack29.us.epil, ptr %.repack30.us.epil, align 8, !tbaa !156
  br label %omp.wsloop.region22.omp.wsloop.region24_crit_edge.us

omp.wsloop.region22.omp.wsloop.region24_crit_edge.us: ; preds = %omp.wsloop.region22.omp.wsloop.region24_crit_edge.us.unr-lcssa, %omp.wsloop.region23.us.epil
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1
  %exitcond55.not = icmp eq i64 %indvars.iv.next53, %67
...
omp_collapsed.body.lr.ph:                         ; preds = %omp.par.entry
  ...
  %26 = shl i64 %25, 4
  %27 = shl i64 %5, 4
  %invariant.gep101 = getelementptr i8, ptr %loadgep_10, i64 -16
  %invariant.gep103 = getelementptr i8, ptr %loadgep_10, i64 -8
  br label %omp_collapsed.body
...
omp_collapsed.body:                               ; preds = %omp_collapsed.body.lr.ph, %omp.wsloop.region25
  %28 = phi i32 [ %.pre, %omp_collapsed.body.lr.ph ], [ %82, %omp.wsloop.region25 ]
...
omp.wsloop.region15.us.preheader:                 ; preds = %omp.wsloop.region15.lr.ph
  ...
  %43 = add nsw i64 %41, -1
  %44 = add i32 %34, 1
  %min.iters.check65 = icmp ult i32 %33, 6
  %45 = trunc nsw i64 %43 to i32
  %46 = add i32 %44, %45
  %47 = icmp slt i32 %46, %44
  %48 = icmp ugt i64 %43, 4294967295
  %49 = or i1 %47, %48
  %n.vec68 = and i64 %41, 2147483646
  %ind.end69 = or i64 %41, 1
  %cmp.n71 = icmp eq i64 %n.vec68, %41
...
omp.wsloop.region15.us:                           ; preds = %omp.wsloop.region15.us.preheader, %omp.wsloop.region16.omp.wsloop.region18_crit_edge.us
  ...
  %brmerge = select i1 %min.iters.check65, i1 true, i1 %49
  br i1 %brmerge, label %omp.wsloop.region17.us.preheader, label %vector.ph66

vector.ph66:                                      ; preds = %omp.wsloop.region15.us
  %invariant.gep = getelementptr i8, ptr %52, i64 -16
  %invariant.gep83 = getelementptr i8, ptr %54, i64 -16
  br label %vector.body72

vector.body72:                                    ; preds = %vector.body72, %vector.ph66
  %index73 = phi i64 [ 0, %vector.ph66 ], [ %index.next80, %vector.body72 ]
  %offset.idx74 = or disjoint i64 %index73, 1
  %55 = trunc i64 %index73 to i32
  %56 = or disjoint i32 %55, 1
  %57 = add i32 %34, %56
  %58 = sext i32 %57 to i64
  %gep = getelementptr { double, double }, ptr %invariant.gep, i64 %58
  %wide.vec76 = load <4 x double>, ptr %gep, align 8, !tbaa !176
  %gep84 = getelementptr { double, double }, ptr %invariant.gep83, i64 %offset.idx74
  store <4 x double> %wide.vec76, ptr %gep84, align 8, !tbaa !169
  %index.next80 = add nuw i64 %index73, 2
  %59 = icmp eq i64 %index.next80, %n.vec68
  br i1 %59, label %middle.block63, label %vector.body72, !llvm.loop !178

middle.block63:                                   ; preds = %vector.body72
  br i1 %cmp.n71, label %omp.wsloop.region16.omp.wsloop.region18_crit_edge.us, label %omp.wsloop.region17.us.preheader

omp.wsloop.region17.us.preheader:                 ; preds = %omp.wsloop.region15.us, %middle.block63
  %indvars.iv.ph = phi i64 [ 1, %omp.wsloop.region15.us ], [ %ind.end69, %middle.block63 ]
  br i1 %lcmp.mod.not, label %omp.wsloop.region17.us.prol.loopexit, label %omp.wsloop.region17.us.prol

omp.wsloop.region17.us.prol:                      ; preds = %omp.wsloop.region17.us.preheader
  %60 = trunc nuw nsw i64 %indvars.iv.ph to i32
  %61 = add i32 %34, %60
  %62 = sext i32 %61 to i64
  %63 = getelementptr { double, double }, ptr %52, i64 %62
  %64 = getelementptr i8, ptr %63, i64 -16
  %.unpack32.us.prol = load double, ptr %64, align 8, !tbaa !176
  %.elt33.us.prol = getelementptr i8, ptr %63, i64 -8
  %.unpack34.us.prol = load double, ptr %.elt33.us.prol, align 8, !tbaa !176
  %65 = getelementptr { double, double }, ptr %54, i64 %indvars.iv.ph
  %66 = getelementptr i8, ptr %65, i64 -16
  store double %.unpack32.us.prol, ptr %66, align 8, !tbaa !169
  %.repack35.us.prol = getelementptr i8, ptr %65, i64 -8
  store double %.unpack34.us.prol, ptr %.repack35.us.prol, align 8, !tbaa !169
  %indvars.iv.next.prol = add nuw nsw i64 %indvars.iv.ph, 1
  br label %omp.wsloop.region17.us.prol.loopexit

omp.wsloop.region17.us.prol.loopexit:             ; preds = %omp.wsloop.region17.us.prol, %omp.wsloop.region17.us.preheader
  %indvars.iv.unr = phi i64 [ %indvars.iv.ph, %omp.wsloop.region17.us.preheader ], [ %indvars.iv.next.prol, %omp.wsloop.region17.us.prol ]
  %67 = icmp eq i64 %indvars.iv.ph, %41
  br i1 %67, label %omp.wsloop.region16.omp.wsloop.region18_crit_edge.us, label %omp.wsloop.region17.us

omp.wsloop.region17.us:                           ; preds = %omp.wsloop.region17.us.prol.loopexit, %omp.wsloop.region17.us
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %omp.wsloop.region17.us ], [ %indvars.iv.unr, %omp.wsloop.region17.us.prol.loopexit ]
  %68 = trunc nuw nsw i64 %indvars.iv to i32
  %69 = add i32 %34, %68
  %70 = sext i32 %69 to i64
  %71 = getelementptr { double, double }, ptr %52, i64 %70
  %72 = getelementptr i8, ptr %71, i64 -16
  %.unpack32.us = load double, ptr %72, align 8, !tbaa !176
  %.elt33.us = getelementptr i8, ptr %71, i64 -8
  %.unpack34.us = load double, ptr %.elt33.us, align 8, !tbaa !176
  %73 = getelementptr { double, double }, ptr %54, i64 %indvars.iv
  %74 = getelementptr i8, ptr %73, i64 -16
  store double %.unpack32.us, ptr %74, align 8, !tbaa !169
  %.repack35.us = getelementptr i8, ptr %73, i64 -8
  store double %.unpack34.us, ptr %.repack35.us, align 8, !tbaa !169
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %75 = trunc nuw nsw i64 %indvars.iv.next to i32
  %76 = add i32 %34, %75
  %77 = sext i32 %76 to i64
  %78 = getelementptr { double, double }, ptr %52, i64 %77
  %79 = getelementptr i8, ptr %78, i64 -16
  %.unpack32.us.1 = load double, ptr %79, align 8, !tbaa !176
  %.elt33.us.1 = getelementptr i8, ptr %78, i64 -8
  %.unpack34.us.1 = load double, ptr %.elt33.us.1, align 8, !tbaa !176
  %80 = getelementptr { double, double }, ptr %54, i64 %indvars.iv.next
  %81 = getelementptr i8, ptr %80, i64 -16
  store double %.unpack32.us.1, ptr %81, align 8, !tbaa !169
  %.repack35.us.1 = getelementptr i8, ptr %80, i64 -8
  store double %.unpack34.us.1, ptr %.repack35.us.1, align 8, !tbaa !169
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next, %41
  br i1 %exitcond.not.1, label %omp.wsloop.region16.omp.wsloop.region18_crit_edge.us, label %omp.wsloop.region17.us, !llvm.loop !179

omp.wsloop.region16.omp.wsloop.region18_crit_edge.us: ; preds = %omp.wsloop.region17.us.prol.loopexit, %omp.wsloop.region17.us, %middle.block63
...
omp.wsloop.region19:                              ; preds = %omp.wsloop.region16.omp.wsloop.region18_crit_edge.us, %omp.wsloop.region15.lr.ph, %omp_collapsed.body
  call void @cfftz_(ptr %loadgep_6, ptr %loadgep_8, ptr nonnull %loadgep_4, ptr nonnull %10, ptr nonnull %12) #6
  %82 = load i32, ptr %loadgep_4, align 4, !tbaa !174
  %83 = icmp sgt i32 %82, 0
  br i1 %83, label %omp.wsloop.region21.lr.ph, label %omp.wsloop.region25

omp.wsloop.region21.lr.ph:                        ; preds = %omp.wsloop.region19
  %84 = load i32, ptr @_QMft_dataEfftblock, align 4, !tbaa !172
  %85 = icmp sgt i32 %84, 0
  %86 = sext i32 %32 to i64
  %87 = add nsw i64 %86, -1
  %88 = mul nsw i64 %24, %87
  %89 = getelementptr { double, double }, ptr %loadgep_10, i64 %88
  br i1 %85, label %omp.wsloop.region21.us.preheader, label %omp.wsloop.region25

omp.wsloop.region21.us.preheader:                 ; preds = %omp.wsloop.region21.lr.ph
  %90 = zext nneg i32 %84 to i64
  %narrow55 = add nuw i32 %82, 1
  %91 = zext i32 %narrow55 to i64
  %92 = add nsw i64 %90, -1
  %93 = add i32 %34, 1
  %94 = mul i64 %26, %87
  %min.iters.check = icmp ult i32 %84, 28
  ...
  %gep102 = getelementptr i8, ptr %invariant.gep101, i64 %94
  %invariant.gep93 = getelementptr i8, ptr %gep102, i64 %101
  %mul.result = shl nsw i64 %92, 4
  %gep104 = getelementptr i8, ptr %invariant.gep103, i64 %94
  %invariant.gep99 = getelementptr i8, ptr %gep104, i64 %101
  %mul.result58 = shl nsw i64 %92, 4
  %n.vec = and i64 %90, 2147483646
  %ind.end = or i64 %90, 1
  %cmp.n = icmp eq i64 %n.vec, %90
  %xtraiter81 = and i64 %90, 1
...
omp.wsloop.region21.us:                           ; preds = %omp.wsloop.region21.us.preheader, %omp.wsloop.region22.omp.wsloop.region24_crit_edge.us
  ...
  %102 = add nsw i64 %indvars.iv50, -1
  %103 = mul nsw i64 %102, %1
  %104 = getelementptr { double, double }, ptr %10, i64 %103
  %105 = mul nsw i64 %102, %5
  %106 = getelementptr { double, double }, ptr %89, i64 %105
...
vector.scevcheck:                                 ; preds = %omp.wsloop.region21.us
  %107 = mul i64 %27, %indvar
  %gep94 = getelementptr i8, ptr %invariant.gep93, i64 %107
  %108 = getelementptr i8, ptr %gep94, i64 %mul.result
  %109 = icmp ult ptr %108, %gep94
  %gep100 = getelementptr i8, ptr %invariant.gep99, i64 %107
  %110 = getelementptr i8, ptr %gep100, i64 %mul.result58
  %111 = icmp ult ptr %110, %gep100
  %112 = or i1 %109, %99
  %113 = or i1 %111, %112
  br i1 %113, label %omp.wsloop.region23.us.preheader, label %vector.ph

vector.ph:                                        ; preds = %vector.scevcheck
  %invariant.gep85 = getelementptr i8, ptr %104, i64 -16
  %invariant.gep87 = getelementptr i8, ptr %106, i64 -16
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %offset.idx = or disjoint i64 %index, 1
  %114 = trunc i64 %index to i32
  %115 = or disjoint i32 %114, 1
  %gep86 = getelementptr { double, double }, ptr %invariant.gep85, i64 %offset.idx
  %wide.vec = load <4 x double>, ptr %gep86, align 8, !tbaa !169
  %116 = add i32 %34, %115
  %117 = sext i32 %116 to i64
  %gep88 = getelementptr { double, double }, ptr %invariant.gep87, i64 %117
  store <4 x double> %wide.vec, ptr %gep88, align 8, !tbaa !180
  %index.next = add nuw i64 %index, 2
  %118 = icmp eq i64 %index.next, %n.vec
  br i1 %118, label %middle.block, label %vector.body, !llvm.loop !182
...
omp.wsloop.region23.us.preheader:                 ; preds = %vector.scevcheck, %omp.wsloop.region21.us, %middle.block
  ...
  br i1 %lcmp.mod82.not, label %omp.wsloop.region23.us.prol.loopexit, label %omp.wsloop.region23.us.prol

omp.wsloop.region23.us.prol:                      ; preds = %omp.wsloop.region23.us.preheader
  %119 = getelementptr { double, double }, ptr %104, i64 %indvars.iv46.ph
  %120 = getelementptr i8, ptr %119, i64 -16
  %.unpack.us.prol = load double, ptr %120, align 8, !tbaa !169
  %.elt28.us.prol = getelementptr i8, ptr %119, i64 -8
  %.unpack29.us.prol = load double, ptr %.elt28.us.prol, align 8, !tbaa !169
  %121 = trunc nuw nsw i64 %indvars.iv46.ph to i32
  %122 = add i32 %34, %121
  %123 = sext i32 %122 to i64
  %124 = getelementptr { double, double }, ptr %106, i64 %123
  %125 = getelementptr i8, ptr %124, i64 -16
  store double %.unpack.us.prol, ptr %125, align 8, !tbaa !180
  %.repack30.us.prol = getelementptr i8, ptr %124, i64 -8
  store double %.unpack29.us.prol, ptr %.repack30.us.prol, align 8, !tbaa !180
  %indvars.iv.next47.prol = add nuw nsw i64 %indvars.iv46.ph, 1
  br label %omp.wsloop.region23.us.prol.loopexit

omp.wsloop.region23.us.prol.loopexit:             ; preds = %omp.wsloop.region23.us.prol, %omp.wsloop.region23.us.preheader
  %indvars.iv46.unr = phi i64 [ %indvars.iv46.ph, %omp.wsloop.region23.us.preheader ], [ %indvars.iv.next47.prol, %omp.wsloop.region23.us.prol ]
  %126 = icmp eq i64 %indvars.iv46.ph, %90
  br i1 %126, label %omp.wsloop.region22.omp.wsloop.region24_crit_edge.us, label %omp.wsloop.region23.us

omp.wsloop.region23.us:                           ; preds = %omp.wsloop.region23.us.prol.loopexit, %omp.wsloop.region23.us
  %indvars.iv46 = phi i64 [ %indvars.iv.next47.1, %omp.wsloop.region23.us ], [ %indvars.iv46.unr, %omp.wsloop.region23.us.prol.loopexit ]
  %127 = getelementptr { double, double }, ptr %104, i64 %indvars.iv46
  %128 = getelementptr i8, ptr %127, i64 -16
  %.unpack.us = load double, ptr %128, align 8, !tbaa !169
  %.elt28.us = getelementptr i8, ptr %127, i64 -8
  %.unpack29.us = load double, ptr %.elt28.us, align 8, !tbaa !169
  %129 = trunc nuw nsw i64 %indvars.iv46 to i32
  %130 = add i32 %34, %129
  %131 = sext i32 %130 to i64
  %132 = getelementptr { double, double }, ptr %106, i64 %131
  %133 = getelementptr i8, ptr %132, i64 -16
  store double %.unpack.us, ptr %133, align 8, !tbaa !180
  %.repack30.us = getelementptr i8, ptr %132, i64 -8
  store double %.unpack29.us, ptr %.repack30.us, align 8, !tbaa !180
  %indvars.iv.next47 = add nuw nsw i64 %indvars.iv46, 1
  %134 = getelementptr { double, double }, ptr %104, i64 %indvars.iv.next47
  %135 = getelementptr i8, ptr %134, i64 -16
  %.unpack.us.1 = load double, ptr %135, align 8, !tbaa !169
  %.elt28.us.1 = getelementptr i8, ptr %134, i64 -8
  %.unpack29.us.1 = load double, ptr %.elt28.us.1, align 8, !tbaa !169
  %136 = trunc nuw nsw i64 %indvars.iv.next47 to i32
  %137 = add i32 %34, %136
  %138 = sext i32 %137 to i64
  %139 = getelementptr { double, double }, ptr %106, i64 %138
  %140 = getelementptr i8, ptr %139, i64 -16
  store double %.unpack.us.1, ptr %140, align 8, !tbaa !180
  %.repack30.us.1 = getelementptr i8, ptr %139, i64 -8
  store double %.unpack29.us.1, ptr %.repack30.us.1, align 8, !tbaa !180
  %indvars.iv.next47.1 = add nuw nsw i64 %indvars.iv46, 2
  %exitcond49.not.1 = icmp eq i64 %indvars.iv.next47, %90
  br i1 %exitcond49.not.1, label %omp.wsloop.region22.omp.wsloop.region24_crit_edge.us, label %omp.wsloop.region23.us, !llvm.loop !183

omp.wsloop.region22.omp.wsloop.region24_crit_edge.us: ; preds = %omp.wsloop.region23.us.prol.loopexit, %omp.wsloop.region23.us, %middle.block
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  %exitcond53.not = icmp eq i64 %indvars.iv.next51, %91
...
omp_collapsed.body.lr.ph:                         ; preds = %omp.par.entry
  ...
  %26 = mul i64 %6, %5
  %27 = shl i64 %26, 4
  %invariant.gep104 = getelementptr i8, ptr %loadgep_10, i64 -16
  %invariant.gep106 = getelementptr i8, ptr %loadgep_10, i64 -8
  br label %omp_collapsed.body
...
omp_collapsed.body:                               ; preds = %omp_collapsed.body.lr.ph, %omp.wsloop.region25
  %28 = phi i32 [ %.pre, %omp_collapsed.body.lr.ph ], [ %80, %omp.wsloop.region25 ]
  %omp_collapsed.iv40 = phi i32 [ 0, %omp_collapsed.body.lr.ph ], [ %omp_collapsed.next, %omp.wsloop.region25 ]
...
omp.wsloop.region15.us.preheader:                 ; preds = %omp.wsloop.region15.lr.ph
  ...
  %42 = add nsw i64 %40, -1
  %43 = add i32 %34, 1
  %min.iters.check67 = icmp ult i32 %33, 6
  %44 = trunc nsw i64 %42 to i32
  %45 = add i32 %43, %44
  %46 = icmp slt i32 %45, %43
  %47 = icmp ugt i64 %42, 4294967295
  %48 = or i1 %46, %47
  %n.vec70 = and i64 %40, 2147483646
  %ind.end71 = or i64 %40, 1
  %cmp.n73 = icmp eq i64 %n.vec70, %40
...
omp.wsloop.region15.us:                           ; preds = %omp.wsloop.region15.us.preheader, %omp.wsloop.region16.omp.wsloop.region18_crit_edge.us
  ...
  %brmerge = select i1 %min.iters.check67, i1 true, i1 %48
  br i1 %brmerge, label %omp.wsloop.region17.us.preheader, label %vector.ph68

vector.ph68:                                      ; preds = %omp.wsloop.region15.us
  %invariant.gep85 = getelementptr i8, ptr %gep.us, i64 -16
  %invariant.gep86 = getelementptr i8, ptr %52, i64 -16
  br label %vector.body74

vector.body74:                                    ; preds = %vector.body74, %vector.ph68
  %index75 = phi i64 [ 0, %vector.ph68 ], [ %index.next82, %vector.body74 ]
  %offset.idx76 = or disjoint i64 %index75, 1
  %53 = trunc i64 %index75 to i32
  %54 = or disjoint i32 %53, 1
  %55 = add i32 %34, %54
  %56 = sext i32 %55 to i64
  %gep = getelementptr { double, double }, ptr %invariant.gep85, i64 %56
  %wide.vec78 = load <4 x double>, ptr %gep, align 8, !tbaa !202
  %gep87 = getelementptr { double, double }, ptr %invariant.gep86, i64 %offset.idx76
  store <4 x double> %wide.vec78, ptr %gep87, align 8, !tbaa !195
  %index.next82 = add nuw i64 %index75, 2
  %57 = icmp eq i64 %index.next82, %n.vec70
  br i1 %57, label %middle.block65, label %vector.body74, !llvm.loop !204

middle.block65:                                   ; preds = %vector.body74
  br i1 %cmp.n73, label %omp.wsloop.region16.omp.wsloop.region18_crit_edge.us, label %omp.wsloop.region17.us.preheader

omp.wsloop.region17.us.preheader:                 ; preds = %omp.wsloop.region15.us, %middle.block65
  %indvars.iv.ph = phi i64 [ 1, %omp.wsloop.region15.us ], [ %ind.end71, %middle.block65 ]
  br i1 %lcmp.mod.not, label %omp.wsloop.region17.us.prol.loopexit, label %omp.wsloop.region17.us.prol

omp.wsloop.region17.us.prol:                      ; preds = %omp.wsloop.region17.us.preheader
  %58 = trunc nuw nsw i64 %indvars.iv.ph to i32
  %59 = add i32 %34, %58
  %60 = sext i32 %59 to i64
  %61 = getelementptr { double, double }, ptr %gep.us, i64 %60
  %62 = getelementptr i8, ptr %61, i64 -16
  %.unpack32.us.prol = load double, ptr %62, align 8, !tbaa !202
  %.elt33.us.prol = getelementptr i8, ptr %61, i64 -8
  %.unpack34.us.prol = load double, ptr %.elt33.us.prol, align 8, !tbaa !202
  %63 = getelementptr { double, double }, ptr %52, i64 %indvars.iv.ph
  %64 = getelementptr i8, ptr %63, i64 -16
  store double %.unpack32.us.prol, ptr %64, align 8, !tbaa !195
  %.repack35.us.prol = getelementptr i8, ptr %63, i64 -8
  store double %.unpack34.us.prol, ptr %.repack35.us.prol, align 8, !tbaa !195
  %indvars.iv.next.prol = add nuw nsw i64 %indvars.iv.ph, 1
  br label %omp.wsloop.region17.us.prol.loopexit

omp.wsloop.region17.us.prol.loopexit:             ; preds = %omp.wsloop.region17.us.prol, %omp.wsloop.region17.us.preheader
  %indvars.iv.unr = phi i64 [ %indvars.iv.ph, %omp.wsloop.region17.us.preheader ], [ %indvars.iv.next.prol, %omp.wsloop.region17.us.prol ]
  %65 = icmp eq i64 %indvars.iv.ph, %40
  br i1 %65, label %omp.wsloop.region16.omp.wsloop.region18_crit_edge.us, label %omp.wsloop.region17.us
...
omp.wsloop.region17.us:                           ; preds = %omp.wsloop.region17.us.prol.loopexit, %omp.wsloop.region17.us
  ...
  %69 = getelementptr { double, double }, ptr %gep.us, i64 %68
  %70 = getelementptr i8, ptr %69, i64 -16
  %.unpack32.us = load double, ptr %70, align 8, !tbaa !202
  %.elt33.us = getelementptr i8, ptr %69, i64 -8
  %.unpack34.us = load double, ptr %.elt33.us, align 8, !tbaa !202
  %71 = getelementptr { double, double }, ptr %52, i64 %indvars.iv
  %72 = getelementptr i8, ptr %71, i64 -16
  store double %.unpack32.us, ptr %72, align 8, !tbaa !195
  %.repack35.us = getelementptr i8, ptr %71, i64 -8
  store double %.unpack34.us, ptr %.repack35.us, align 8, !tbaa !195
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %73 = trunc nuw nsw i64 %indvars.iv.next to i32
  %74 = add i32 %34, %73
  %75 = sext i32 %74 to i64
  %76 = getelementptr { double, double }, ptr %gep.us, i64 %75
  %77 = getelementptr i8, ptr %76, i64 -16
  %.unpack32.us.1 = load double, ptr %77, align 8, !tbaa !202
  %.elt33.us.1 = getelementptr i8, ptr %76, i64 -8
  %.unpack34.us.1 = load double, ptr %.elt33.us.1, align 8, !tbaa !202
  %78 = getelementptr { double, double }, ptr %52, i64 %indvars.iv.next
  %79 = getelementptr i8, ptr %78, i64 -16
  store double %.unpack32.us.1, ptr %79, align 8, !tbaa !195
  %.repack35.us.1 = getelementptr i8, ptr %78, i64 -8
  store double %.unpack34.us.1, ptr %.repack35.us.1, align 8, !tbaa !195
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next, %40
  br i1 %exitcond.not.1, label %omp.wsloop.region16.omp.wsloop.region18_crit_edge.us, label %omp.wsloop.region17.us, !llvm.loop !205

omp.wsloop.region16.omp.wsloop.region18_crit_edge.us: ; preds = %omp.wsloop.region17.us.prol.loopexit, %omp.wsloop.region17.us, %middle.block65
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv44, 1
...
omp.wsloop.region19:                              ; preds = %omp.wsloop.region16.omp.wsloop.region18_crit_edge.us, %omp.wsloop.region15.lr.ph, %omp_collapsed.body
  call void @cfftz_(ptr %loadgep_6, ptr %loadgep_8, ptr nonnull %loadgep_4, ptr nonnull %10, ptr nonnull %12) #6
  %80 = load i32, ptr %loadgep_4, align 4, !tbaa !200
  %81 = icmp sgt i32 %80, 0
  br i1 %81, label %omp.wsloop.region21.lr.ph, label %omp.wsloop.region25

omp.wsloop.region21.lr.ph:                        ; preds = %omp.wsloop.region19
  %82 = load i32, ptr @_QMft_dataEfftblock, align 4, !tbaa !198
  %83 = icmp sgt i32 %82, 0
  %84 = sext i32 %32 to i64
  %85 = add nsw i64 %84, -1
  %86 = mul nsw i64 %85, %5
  %invariant.gep37 = getelementptr { double, double }, ptr %loadgep_10, i64 %86
  br i1 %83, label %omp.wsloop.region21.us.preheader, label %omp.wsloop.region25

omp.wsloop.region21.us.preheader:                 ; preds = %omp.wsloop.region21.lr.ph
  %87 = zext nneg i32 %82 to i64
  %narrow57 = add nuw i32 %80, 1
  %88 = zext i32 %narrow57 to i64
  %89 = add nsw i64 %87, -1
  %90 = add i32 %34, 1
  %91 = mul i64 %25, %85
  %min.iters.check = icmp ult i32 %82, 28
  %92 = trunc nsw i64 %89 to i32
  %93 = add i32 %90, %92
  %94 = icmp slt i32 %93, %90
  %95 = icmp ugt i64 %89, 4294967295
  %96 = or i1 %94, %95
  %97 = sext i32 %90 to i64
  %98 = shl nsw i64 %97, 4
  %gep105 = getelementptr i8, ptr %invariant.gep104, i64 %91
  %invariant.gep96 = getelementptr i8, ptr %gep105, i64 %98
  %mul.result = shl nsw i64 %89, 4
  %gep107 = getelementptr i8, ptr %invariant.gep106, i64 %91
  %invariant.gep102 = getelementptr i8, ptr %gep107, i64 %98
  %mul.result60 = shl nsw i64 %89, 4
  %n.vec = and i64 %87, 2147483646
  %ind.end = or i64 %87, 1
  %cmp.n = icmp eq i64 %n.vec, %87
  %xtraiter83 = and i64 %87, 1
...
omp.wsloop.region21.us:                           ; preds = %omp.wsloop.region21.us.preheader, %omp.wsloop.region22.omp.wsloop.region24_crit_edge.us
  %indvar = phi i64 [ 0, %omp.wsloop.region21.us.preheader ], [ %indvar.next, %omp.wsloop.region22.omp.wsloop.region24_crit_edge.us ]
  %indvars.iv52 = phi i64 [ 1, %omp.wsloop.region21.us.preheader ], [ %indvars.iv.next53, %omp.wsloop.region22.omp.wsloop.region24_crit_edge.us ]
  %99 = add nsw i64 %indvars.iv52, -1
  %100 = mul nsw i64 %99, %1
  %101 = getelementptr { double, double }, ptr %10, i64 %100
  %102 = mul nsw i64 %24, %99
  %gep.us38 = getelementptr { double, double }, ptr %invariant.gep37, i64 %102
  br i1 %min.iters.check, label %omp.wsloop.region23.us.preheader, label %vector.scevcheck

vector.scevcheck:                                 ; preds = %omp.wsloop.region21.us
  %103 = mul i64 %27, %indvar
  %gep97 = getelementptr i8, ptr %invariant.gep96, i64 %103
  %104 = getelementptr i8, ptr %gep97, i64 %mul.result
  %105 = icmp ult ptr %104, %gep97
  %gep103 = getelementptr i8, ptr %invariant.gep102, i64 %103
  %106 = getelementptr i8, ptr %gep103, i64 %mul.result60
  %107 = icmp ult ptr %106, %gep103
  %108 = or i1 %105, %96
  %109 = or i1 %107, %108
  br i1 %109, label %omp.wsloop.region23.us.preheader, label %vector.ph

vector.ph:                                        ; preds = %vector.scevcheck
  %invariant.gep88 = getelementptr i8, ptr %101, i64 -16
  %invariant.gep90 = getelementptr i8, ptr %gep.us38, i64 -16
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %offset.idx = or disjoint i64 %index, 1
  %110 = trunc i64 %index to i32
  %111 = or disjoint i32 %110, 1
  %gep89 = getelementptr { double, double }, ptr %invariant.gep88, i64 %offset.idx
  %wide.vec = load <4 x double>, ptr %gep89, align 8, !tbaa !195
  %112 = add i32 %34, %111
  %113 = sext i32 %112 to i64
  %gep91 = getelementptr { double, double }, ptr %invariant.gep90, i64 %113
  store <4 x double> %wide.vec, ptr %gep91, align 8, !tbaa !206
  %index.next = add nuw i64 %index, 2
  %114 = icmp eq i64 %index.next, %n.vec
  br i1 %114, label %middle.block, label %vector.body, !llvm.loop !208
...
omp.wsloop.region23.us.preheader:                 ; preds = %vector.scevcheck, %omp.wsloop.region21.us, %middle.block
  ...
  br i1 %lcmp.mod84.not, label %omp.wsloop.region23.us.prol.loopexit, label %omp.wsloop.region23.us.prol

omp.wsloop.region23.us.prol:                      ; preds = %omp.wsloop.region23.us.preheader
  %115 = getelementptr { double, double }, ptr %101, i64 %indvars.iv48.ph
  %116 = getelementptr i8, ptr %115, i64 -16
  %.unpack.us.prol = load double, ptr %116, align 8, !tbaa !195
  %.elt28.us.prol = getelementptr i8, ptr %115, i64 -8
  %.unpack29.us.prol = load double, ptr %.elt28.us.prol, align 8, !tbaa !195
  %117 = trunc nuw nsw i64 %indvars.iv48.ph to i32
  %118 = add i32 %34, %117
  %119 = sext i32 %118 to i64
  %120 = getelementptr { double, double }, ptr %gep.us38, i64 %119
  %121 = getelementptr i8, ptr %120, i64 -16
  store double %.unpack.us.prol, ptr %121, align 8, !tbaa !206
  %.repack30.us.prol = getelementptr i8, ptr %120, i64 -8
  store double %.unpack29.us.prol, ptr %.repack30.us.prol, align 8, !tbaa !206
  %indvars.iv.next49.prol = add nuw nsw i64 %indvars.iv48.ph, 1
  br label %omp.wsloop.region23.us.prol.loopexit

omp.wsloop.region23.us.prol.loopexit:             ; preds = %omp.wsloop.region23.us.prol, %omp.wsloop.region23.us.preheader
  %indvars.iv48.unr = phi i64 [ %indvars.iv48.ph, %omp.wsloop.region23.us.preheader ], [ %indvars.iv.next49.prol, %omp.wsloop.region23.us.prol ]
  %122 = icmp eq i64 %indvars.iv48.ph, %87
  br i1 %122, label %omp.wsloop.region22.omp.wsloop.region24_crit_edge.us, label %omp.wsloop.region23.us

omp.wsloop.region23.us:                           ; preds = %omp.wsloop.region23.us.prol.loopexit, %omp.wsloop.region23.us
  %indvars.iv48 = phi i64 [ %indvars.iv.next49.1, %omp.wsloop.region23.us ], [ %indvars.iv48.unr, %omp.wsloop.region23.us.prol.loopexit ]
  %123 = getelementptr { double, double }, ptr %101, i64 %indvars.iv48
  %124 = getelementptr i8, ptr %123, i64 -16
  %.unpack.us = load double, ptr %124, align 8, !tbaa !195
  %.elt28.us = getelementptr i8, ptr %123, i64 -8
  %.unpack29.us = load double, ptr %.elt28.us, align 8, !tbaa !195
  %125 = trunc nuw nsw i64 %indvars.iv48 to i32
  %126 = add i32 %34, %125
  %127 = sext i32 %126 to i64
  %128 = getelementptr { double, double }, ptr %gep.us38, i64 %127
  %129 = getelementptr i8, ptr %128, i64 -16
  store double %.unpack.us, ptr %129, align 8, !tbaa !206
  %.repack30.us = getelementptr i8, ptr %128, i64 -8
  store double %.unpack29.us, ptr %.repack30.us, align 8, !tbaa !206
  %indvars.iv.next49 = add nuw nsw i64 %indvars.iv48, 1
  %130 = getelementptr { double, double }, ptr %101, i64 %indvars.iv.next49
  %131 = getelementptr i8, ptr %130, i64 -16
  %.unpack.us.1 = load double, ptr %131, align 8, !tbaa !195
  %.elt28.us.1 = getelementptr i8, ptr %130, i64 -8
  %.unpack29.us.1 = load double, ptr %.elt28.us.1, align 8, !tbaa !195
  %132 = trunc nuw nsw i64 %indvars.iv.next49 to i32
  %133 = add i32 %34, %132
  %134 = sext i32 %133 to i64
  %135 = getelementptr { double, double }, ptr %gep.us38, i64 %134
  %136 = getelementptr i8, ptr %135, i64 -16
  store double %.unpack.us.1, ptr %136, align 8, !tbaa !206
  %.repack30.us.1 = getelementptr i8, ptr %135, i64 -8
  store double %.unpack29.us.1, ptr %.repack30.us.1, align 8, !tbaa !206
  %indvars.iv.next49.1 = add nuw nsw i64 %indvars.iv48, 2
  %exitcond51.not.1 = icmp eq i64 %indvars.iv.next49, %87
  br i1 %exitcond51.not.1, label %omp.wsloop.region22.omp.wsloop.region24_crit_edge.us, label %omp.wsloop.region23.us, !llvm.loop !209

omp.wsloop.region22.omp.wsloop.region24_crit_edge.us: ; preds = %omp.wsloop.region23.us.prol.loopexit, %omp.wsloop.region23.us, %middle.block
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1
  %exitcond55.not = icmp eq i64 %indvars.iv.next53, %88
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond55.not, label %omp.wsloop.region25, label %omp.wsloop.region21.us
...
.lr.ph.preheader:                                 ; preds = %.lr.ph21
  ...
  %min.iters.check = icmp ult i64 %19, 14
...
21:                                               ; preds = %5
  %22 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX7c1e67f93fcb28e2cdcb18010587e00c, i64 100, ptr null, i32 6, ptr nonnull @_QQclXef2a3d277f21696c502d88d66b82bd8a, i32 721)
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %70
  %.020 = phi i32 [ %72, %70 ], [ %33, %.lr.ph.preheader ]
  %storemerge19 = phi i32 [ %73, %70 ], [ 1, %.lr.ph.preheader ]
...
vector.body:                                      ; preds = %vector.scevcheck, %vector.body
  ...
  %offset.idx = or disjoint i64 %index, 1
  %56 = add nsw i64 %47, %offset.idx
  %57 = getelementptr { double, double }, ptr %4, i64 %56
  %wide.vec = load <4 x double>, ptr %57, align 8, !tbaa !230
  %58 = getelementptr { double, double }, ptr %3, i64 %56
  store <4 x double> %wide.vec, ptr %58, align 8, !tbaa !232
  %index.next = add nuw i64 %index, 2
  %59 = icmp eq i64 %index.next, %n.vec
  br i1 %59, label %middle.block, label %vector.body, !llvm.loop !234
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader
  %60 = add nsw i64 %47, %indvars.iv.ph
  %61 = getelementptr { double, double }, ptr %4, i64 %60
  %.unpack13.us.prol = load double, ptr %61, align 8, !tbaa !230
  %.elt14.us.prol = getelementptr inbounds i8, ptr %61, i64 8
  %.unpack15.us.prol = load double, ptr %.elt14.us.prol, align 8, !tbaa !230
  %62 = getelementptr { double, double }, ptr %3, i64 %60
  store double %.unpack13.us.prol, ptr %62, align 8, !tbaa !232
  %.repack16.us.prol = getelementptr inbounds i8, ptr %62, i64 8
  store double %.unpack15.us.prol, ptr %.repack16.us.prol, align 8, !tbaa !232
  %indvars.iv.next.prol = add nuw nsw i64 %indvars.iv.ph, 1
  br label %scalar.ph.prol.loopexit

scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  %indvars.iv.unr = phi i64 [ %indvars.iv.ph, %scalar.ph.preheader ], [ %indvars.iv.next.prol, %scalar.ph.prol ]
  %63 = icmp eq i64 %indvars.iv.ph, %41
  br i1 %63, label %._crit_edge.us, label %scalar.ph
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %67 = add i64 %46, %indvars.iv
  %68 = getelementptr { double, double }, ptr %4, i64 %67
  %.unpack13.us.1 = load double, ptr %68, align 8, !tbaa !230
  %.elt14.us.1 = getelementptr inbounds i8, ptr %68, i64 8
  %.unpack15.us.1 = load double, ptr %.elt14.us.1, align 8, !tbaa !230
  %69 = getelementptr { double, double }, ptr %3, i64 %67
  store double %.unpack13.us.1, ptr %69, align 8, !tbaa !232
  %.repack16.us.1 = getelementptr inbounds i8, ptr %69, i64 8
  store double %.unpack15.us.1, ptr %.repack16.us.1, align 8, !tbaa !232
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next, %41
  br i1 %exitcond.not.1, label %._crit_edge.us, label %scalar.ph, !llvm.loop !235
...
70:                                               ; preds = %.lr.ph
  %71 = add nuw nsw i32 %storemerge19, 1
  store i32 %71, ptr %6, align 4, !tbaa !225
  ...
  %72 = add nsw i32 %.020, -1
  %73 = add nuw nsw i32 %storemerge19, 2
  store i32 %73, ptr %7, align 4, !tbaa !225
  %74 = icmp sgt i32 %.020, 1
  br i1 %74, label %.lr.ph, label %.loopexit

.loopexit:                                        ; preds = %70, %._crit_edge.us, %.lr.ph23, %30, %36
  ret void
}
...
entry:
  ...
  %17 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX9e8d3c2d987ed8baf86b3735653b66b3, i64 37, ptr null, i32 6, ptr nonnull @_QQclXef2a3d277f21696c502d88d66b82bd8a, i32 863)
...
define void @verify_(ptr nocapture readonly %0, ptr nocapture readonly %1, ptr nocapture readonly %2, ptr nocapture readonly %3, ptr nocapture %4, ptr %5, i64 %6) local_unnamed_addr #0 {
  ...
  %18 = icmp eq i32 %17, 6
  %19 = and i1 %16, %18
  %.sink288.sroa.gep316 = getelementptr inbounds i8, ptr %8, i64 88
  %.sink288.sroa.gep317 = getelementptr inbounds i8, ptr %8, i64 88
  %.sink288.sroa.gep318 = getelementptr inbounds i8, ptr %8, i64 312
  %.sink288.sroa.gep319 = getelementptr inbounds i8, ptr %8, i64 312
  %.sink288.sroa.gep320 = getelementptr inbounds i8, ptr %8, i64 392
  %.sink288.sroa.gep321 = getelementptr inbounds i8, ptr %8, i64 392
  %.sink288.sroa.gep322 = getelementptr inbounds i8, ptr %8, i64 392
  %.sink291.sroa.gep323 = getelementptr inbounds i8, ptr %8, i64 80
  %.sink291.sroa.gep324 = getelementptr inbounds i8, ptr %8, i64 80
  %.sink291.sroa.gep325 = getelementptr inbounds i8, ptr %8, i64 304
  %.sink291.sroa.gep326 = getelementptr inbounds i8, ptr %8, i64 304
  %.sink291.sroa.gep327 = getelementptr inbounds i8, ptr %8, i64 384
  %.sink291.sroa.gep328 = getelementptr inbounds i8, ptr %8, i64 384
  %.sink291.sroa.gep329 = getelementptr inbounds i8, ptr %8, i64 384
  %.sink293.sroa.gep330 = getelementptr inbounds i8, ptr %8, i64 72
  %.sink293.sroa.gep331 = getelementptr inbounds i8, ptr %8, i64 72
  %.sink293.sroa.gep332 = getelementptr inbounds i8, ptr %8, i64 296
  %.sink293.sroa.gep333 = getelementptr inbounds i8, ptr %8, i64 296
  %.sink293.sroa.gep334 = getelementptr inbounds i8, ptr %8, i64 376
  %.sink293.sroa.gep335 = getelementptr inbounds i8, ptr %8, i64 376
  %.sink293.sroa.gep336 = getelementptr inbounds i8, ptr %8, i64 376
  %.sink296.sroa.gep337 = getelementptr inbounds i8, ptr %8, i64 64
  %.sink296.sroa.gep338 = getelementptr inbounds i8, ptr %8, i64 64
  %.sink296.sroa.gep339 = getelementptr inbounds i8, ptr %8, i64 288
  %.sink296.sroa.gep340 = getelementptr inbounds i8, ptr %8, i64 288
  %.sink296.sroa.gep341 = getelementptr inbounds i8, ptr %8, i64 368
  %.sink296.sroa.gep342 = getelementptr inbounds i8, ptr %8, i64 368
  %.sink296.sroa.gep343 = getelementptr inbounds i8, ptr %8, i64 368
  %.sink298.sroa.gep344 = getelementptr inbounds i8, ptr %8, i64 56
  %.sink298.sroa.gep345 = getelementptr inbounds i8, ptr %8, i64 56
  %.sink298.sroa.gep346 = getelementptr inbounds i8, ptr %8, i64 280
  %.sink298.sroa.gep347 = getelementptr inbounds i8, ptr %8, i64 280
  %.sink298.sroa.gep348 = getelementptr inbounds i8, ptr %8, i64 360
  %.sink298.sroa.gep349 = getelementptr inbounds i8, ptr %8, i64 360
  %.sink298.sroa.gep350 = getelementptr inbounds i8, ptr %8, i64 360
  %.sink301.sroa.gep351 = getelementptr inbounds i8, ptr %8, i64 48
  %.sink301.sroa.gep352 = getelementptr inbounds i8, ptr %8, i64 48
  %.sink301.sroa.gep353 = getelementptr inbounds i8, ptr %8, i64 272
  %.sink301.sroa.gep354 = getelementptr inbounds i8, ptr %8, i64 272
  %.sink301.sroa.gep355 = getelementptr inbounds i8, ptr %8, i64 352
  %.sink301.sroa.gep356 = getelementptr inbounds i8, ptr %8, i64 352
  %.sink301.sroa.gep357 = getelementptr inbounds i8, ptr %8, i64 352
  %.sink303.sroa.gep358 = getelementptr inbounds i8, ptr %8, i64 40
  %.sink303.sroa.gep359 = getelementptr inbounds i8, ptr %8, i64 40
  %.sink303.sroa.gep360 = getelementptr inbounds i8, ptr %8, i64 264
  %.sink303.sroa.gep361 = getelementptr inbounds i8, ptr %8, i64 264
  %.sink303.sroa.gep362 = getelementptr inbounds i8, ptr %8, i64 344
  %.sink303.sroa.gep363 = getelementptr inbounds i8, ptr %8, i64 344
  %.sink303.sroa.gep364 = getelementptr inbounds i8, ptr %8, i64 344
  %.sink306.sroa.gep365 = getelementptr inbounds i8, ptr %8, i64 32
  %.sink306.sroa.gep366 = getelementptr inbounds i8, ptr %8, i64 32
  %.sink306.sroa.gep367 = getelementptr inbounds i8, ptr %8, i64 256
  %.sink306.sroa.gep368 = getelementptr inbounds i8, ptr %8, i64 256
  %.sink306.sroa.gep369 = getelementptr inbounds i8, ptr %8, i64 336
  %.sink306.sroa.gep370 = getelementptr inbounds i8, ptr %8, i64 336
  %.sink306.sroa.gep371 = getelementptr inbounds i8, ptr %8, i64 336
  %.sink308.sroa.gep372 = getelementptr inbounds i8, ptr %8, i64 24
  %.sink308.sroa.gep373 = getelementptr inbounds i8, ptr %8, i64 24
  %.sink308.sroa.gep374 = getelementptr inbounds i8, ptr %8, i64 248
  %.sink308.sroa.gep375 = getelementptr inbounds i8, ptr %8, i64 248
  %.sink308.sroa.gep376 = getelementptr inbounds i8, ptr %8, i64 328
  %.sink308.sroa.gep377 = getelementptr inbounds i8, ptr %8, i64 328
  %.sink308.sroa.gep378 = getelementptr inbounds i8, ptr %8, i64 328
  %.sink311.sroa.gep379 = getelementptr inbounds i8, ptr %8, i64 16
  %.sink311.sroa.gep380 = getelementptr inbounds i8, ptr %8, i64 16
  %.sink311.sroa.gep381 = getelementptr inbounds i8, ptr %8, i64 240
  %.sink311.sroa.gep382 = getelementptr inbounds i8, ptr %8, i64 240
  %.sink311.sroa.gep383 = getelementptr inbounds i8, ptr %8, i64 320
  %.sink311.sroa.gep384 = getelementptr inbounds i8, ptr %8, i64 320
  %.sink311.sroa.gep385 = getelementptr inbounds i8, ptr %8, i64 320
  %.sink313.sroa.gep386 = getelementptr inbounds i8, ptr %8, i64 8
  %.sink313.sroa.gep387 = getelementptr inbounds i8, ptr %8, i64 8
  %.sink313.sroa.gep388 = getelementptr inbounds i8, ptr %8, i64 232
  %.sink313.sroa.gep389 = getelementptr inbounds i8, ptr %8, i64 232
  %.sink313.sroa.gep390 = getelementptr inbounds i8, ptr %8, i64 312
  %.sink313.sroa.gep391 = getelementptr inbounds i8, ptr %8, i64 312
  %.sink313.sroa.gep392 = getelementptr inbounds i8, ptr %8, i64 312
  br i1 %19, label %20, label %21

20:                                               ; preds = %7
  %.sink313.sroa.gep = getelementptr inbounds i8, ptr %8, i64 8
  %.sink311.sroa.gep = getelementptr inbounds i8, ptr %8, i64 16
  %.sink308.sroa.gep = getelementptr inbounds i8, ptr %8, i64 24
  %.sink306.sroa.gep = getelementptr inbounds i8, ptr %8, i64 32
  %.sink303.sroa.gep = getelementptr inbounds i8, ptr %8, i64 40
  %.sink301.sroa.gep = getelementptr inbounds i8, ptr %8, i64 48
  %.sink298.sroa.gep = getelementptr inbounds i8, ptr %8, i64 56
  %.sink296.sroa.gep = getelementptr inbounds i8, ptr %8, i64 64
  %.sink293.sroa.gep = getelementptr inbounds i8, ptr %8, i64 72
  %.sink291.sroa.gep = getelementptr inbounds i8, ptr %8, i64 80
  %.sink288.sroa.gep = getelementptr inbounds i8, ptr %8, i64 88
...
.sink.split:                                      ; preds = %142, %115, %88, %65, %44, %36, %28, %20
  %.sink313.sroa.phi = phi ptr [ %.sink313.sroa.gep, %20 ], [ %.sink313.sroa.gep386, %28 ], [ %.sink313.sroa.gep387, %36 ], [ %.sink313.sroa.gep388, %44 ], [ %.sink313.sroa.gep389, %65 ], [ %.sink313.sroa.gep390, %88 ], [ %.sink313.sroa.gep391, %115 ], [ %.sink313.sroa.gep392, %142 ]
  %.sink312 = phi double [ 0x407E4894D21E84F6, %20 ], [ 0x40808A98F467F156, %28 ], [ 0x407FF67A05A82466, %36 ], [ 0x407FF5FA3C741F6E, %44 ], [ 0x40800297DE24048E, %65 ], [ 0x407FFF7769FD4D32, %88 ], [ 0x40800067BBA76761, %115 ], [ 0x408000018639EECE, %142 ]
  %.sink311.sroa.phi = phi ptr [ %.sink311.sroa.gep, %20 ], [ %.sink311.sroa.gep379, %28 ], [ %.sink311.sroa.gep380, %36 ], [ %.sink311.sroa.gep381, %44 ], [ %.sink311.sroa.gep382, %65 ], [ %.sink311.sroa.gep383, %88 ], [ %.sink311.sroa.gep384, %115 ], [ %.sink311.sroa.gep385, %142 ]
  %.sink309 = phi double [ 0x4081551BBB575EAB, %20 ], [ 0x40819926462BA5A4, %28 ], [ 0x407F9F0F4941FB3E, %36 ], [ 0x408004D9F6B6B8E1, %44 ], [ 0x4080086C31EBD984, %65 ], [ 0x407FFDF94909BB13, %88 ], [ 0x407FFFE3A76CE198, %115 ], [ 0x407FFF92ED078D90, %142 ]
  %.sink308.sroa.phi = phi ptr [ %.sink308.sroa.gep, %20 ], [ %.sink308.sroa.gep372, %28 ], [ %.sink308.sroa.gep373, %36 ], [ %.sink308.sroa.gep374, %44 ], [ %.sink308.sroa.gep375, %65 ], [ %.sink308.sroa.gep376, %88 ], [ %.sink308.sroa.gep377, %115 ], [ %.sink308.sroa.gep378, %142 ]
  %.sink307 = phi double [ 0x407E687CA0F87E44, %20 ], [ 0x408081B851380EB7, %28 ], [ 0x407FDE18707A9D72, %36 ], [ 0x407FF6BFE1A61501, %44 ], [ 0x408002A4AAB9F9F8, %65 ], [ 0x407FFF85714411B2, %88 ], [ 0x4080006A3087F53C, %115 ], [ 0x407FFFFE5623050F, %142 ]
  %.sink306.sroa.phi = phi ptr [ %.sink306.sroa.gep, %20 ], [ %.sink306.sroa.gep365, %28 ], [ %.sink306.sroa.gep366, %36 ], [ %.sink306.sroa.gep367, %44 ], [ %.sink306.sroa.gep368, %65 ], [ %.sink306.sroa.gep369, %88 ], [ %.sink306.sroa.gep370, %115 ], [ %.sink306.sroa.gep371, %142 ]
  %.sink304 = phi double [ 0x408154EB318EB593, %20 ], [ 0x40817B3822354DD9, %28 ], [ 0x407FAF00C6D7110A, %36 ], [ 0x408004673C213244, %44 ], [ 0x4080083F8294129E, %65 ], [ 0x407FFE01E8D7E962, %88 ], [ 0x407FFFDDE458AC2A, %115 ], [ 0x407FFF970174A618, %142 ]
  %.sink303.sroa.phi = phi ptr [ %.sink303.sroa.gep, %20 ], [ %.sink303.sroa.gep358, %28 ], [ %.sink303.sroa.gep359, %36 ], [ %.sink303.sroa.gep360, %44 ], [ %.sink303.sroa.gep361, %65 ], [ %.sink303.sroa.gep362, %88 ], [ %.sink303.sroa.gep363, %115 ], [ %.sink303.sroa.gep364, %142 ]
  %.sink302 = phi double [ 0x407E8641D4F55AF9, %20 ], [ 0x408078CC18578DFC, %28 ], [ 0x407FDD07CCB88353, %36 ], [ 0x407FF77327A3F7B0, %44 ], [ 0x408002AF57DC0D71, %65 ], [ 0x407FFF9172826820, %88 ], [ 0x4080006C427E60CB, %115 ], [ 0x407FFFFA2834D94F, %142 ]
  %.sink301.sroa.phi = phi ptr [ %.sink301.sroa.gep, %20 ], [ %.sink301.sroa.gep351, %28 ], [ %.sink301.sroa.gep352, %36 ], [ %.sink301.sroa.gep353, %44 ], [ %.sink301.sroa.gep354, %65 ], [ %.sink301.sroa.gep355, %88 ], [ %.sink301.sroa.gep356, %115 ], [ %.sink301.sroa.gep357, %142 ]
  %.sink299 = phi double [ 0x40815456C13A7B04, %20 ], [ 0x4081608EF5C48194, %28 ], [ 0x407FBCA0EB3ECBEF, %36 ], [ 0x408004007A3FD0EA, %44 ], [ 0x408008151CE457D2, %65 ], [ 0x407FFE0AE8040E41, %88 ], [ 0x407FFFD8379EC190, %115 ], [ 0x407FFF9AB839EC00, %142 ]
  %.sink298.sroa.phi = phi ptr [ %.sink298.sroa.gep, %20 ], [ %.sink298.sroa.gep344, %28 ], [ %.sink298.sroa.gep345, %36 ], [ %.sink298.sroa.gep346, %44 ], [ %.sink298.sroa.gep347, %65 ], [ %.sink298.sroa.gep348, %88 ], [ %.sink298.sroa.gep349, %115 ], [ %.sink298.sroa.gep350, %142 ]
  %.sink297 = phi double [ 0x407EA2097D7357C2, %20 ], [ 0x40807005B7059038, %28 ], [ 0x407FE2234776F4EF, %36 ], [ 0x407FF815F3F1C1DE, %44 ], [ 0x408002B83C8A44C9, %65 ], [ 0x407FFF9BB06626E0, %88 ], [ 0x4080006DFF9235BC, %115 ], [ 0x407FFFF673BF5E5D, %142 ]
  %.sink296.sroa.phi = phi ptr [ %.sink296.sroa.gep, %20 ], [ %.sink296.sroa.gep337, %28 ], [ %.sink296.sroa.gep338, %36 ], [ %.sink296.sroa.gep339, %44 ], [ %.sink296.sroa.gep340, %65 ], [ %.sink296.sroa.gep341, %88 ], [ %.sink296.sroa.gep342, %115 ], [ %.sink296.sroa.gep343, %142 ]
  %.sink294 = phi double [ 0x408153676E9F169C, %20 ], [ 0x408148B81D084E83, %28 ], [ 0x407FC85F79D2C1E9, %36 ], [ 0x408003A43D5F793B, %44 ], [ 0x408007EC8CCD48ED, %65 ], [ 0x407FFE142D872C17, %88 ], [ 0x407FFFD2A76113A7, %115 ], [ 0x407FFF9E1BE99AAD, %142 ]
  %.sink293.sroa.phi = phi ptr [ %.sink293.sroa.gep, %20 ], [ %.sink293.sroa.gep330, %28 ], [ %.sink293.sroa.gep331, %36 ], [ %.sink293.sroa.gep332, %44 ], [ %.sink293.sroa.gep333, %65 ], [ %.sink293.sroa.gep334, %88 ], [ %.sink293.sroa.gep335, %115 ], [ %.sink293.sroa.gep336, %142 ]
  %.sink292 = phi double [ 0x407EBBF61C86EF29, %20 ], [ 0x408067854B0E36C9, %28 ], [ 0x407FE7DD0AF2CEF4, %36 ], [ 0x407FF8AA099402A0, %44 ], [ 0x408002BF9BCECA75, %65 ], [ 0x407FFFA464F89DCE, %88 ], [ 0x4080006F7377203C, %115 ], [ 0x407FFFF32B56A1CC, %142 ]
  %.sink291.sroa.phi = phi ptr [ %.sink291.sroa.gep, %20 ], [ %.sink291.sroa.gep323, %28 ], [ %.sink291.sroa.gep324, %36 ], [ %.sink291.sroa.gep325, %44 ], [ %.sink291.sroa.gep326, %65 ], [ %.sink291.sroa.gep327, %88 ], [ %.sink291.sroa.gep328, %115 ], [ %.sink291.sroa.gep329, %142 ]
  %.sink289 = phi double [ 0x408152259010E0A1, %20 ], [ 0x40813353E9E3E09A, %28 ], [ 0x407FD2611DBB8FA9, %36 ], [ 0x40800351422D2EDF, %44 ], [ 0x408007C58371022F, %65 ], [ 0x407FFE1DA48D386E, %88 ], [ 0x407FFFCD389947BC, %115 ], [ 0x407FFFA135C75993, %142 ]
  %.sink288.sroa.phi = phi ptr [ %.sink288.sroa.gep, %20 ], [ %.sink288.sroa.gep316, %28 ], [ %.sink288.sroa.gep317, %36 ], [ %.sink288.sroa.gep318, %44 ], [ %.sink288.sroa.gep319, %65 ], [ %.sink288.sroa.gep320, %88 ], [ %.sink288.sroa.gep321, %115 ], [ %.sink288.sroa.gep322, %142 ]
  ...
  store double %.sink312, ptr %.sink313.sroa.phi, align 8, !tbaa !286
  store double %.sink309, ptr %.sink311.sroa.phi, align 8, !tbaa !286
  store double %.sink307, ptr %.sink308.sroa.phi, align 8, !tbaa !286
  store double %.sink304, ptr %.sink306.sroa.phi, align 8, !tbaa !286
  store double %.sink302, ptr %.sink303.sroa.phi, align 8, !tbaa !286
  store double %.sink299, ptr %.sink301.sroa.phi, align 8, !tbaa !286
  store double %.sink297, ptr %.sink298.sroa.phi, align 8, !tbaa !286
  store double %.sink294, ptr %.sink296.sroa.phi, align 8, !tbaa !286
  store double %.sink292, ptr %.sink293.sroa.phi, align 8, !tbaa !286
  store double %.sink289, ptr %.sink291.sroa.phi, align 8, !tbaa !286
  store double %.sink, ptr %.sink288.sroa.phi, align 8, !tbaa !286
  br label %162
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %180
  %indvars.iv = phi i64 [ 1, %.lr.ph.preheader ], [ %indvars.iv.next, %180 ]
  ...
  %175 = extractvalue { double, double } %173, 1
  %176 = tail call double @cabs(double %174, double %175)
  %177 = fcmp uno double %176, 0.000000e+00
  %178 = fcmp contract ogt double %176, 0x3D719799812DEA11
  %179 = or i1 %177, %178
...
.loopexit:                                        ; preds = %.lr.ph, %._crit_edge, %162
  %181 = tail call i32 @_FortranACharacterCompareScalar1(ptr nonnull %5, ptr nonnull @_QQclX55, i64 1, i64 1)
  %.not283 = icmp eq i32 %181, 0
  br i1 %.not283, label %189, label %182

182:                                              ; preds = %.loopexit
  %183 = load i32, ptr %4, align 4, !tbaa !287
  %.not284 = icmp eq i32 %183, 0
  br i1 %.not284, label %186, label %184

184:                                              ; preds = %182
  %185 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX55a08c1285b7f0af953f78d40667effb, i64 35, ptr null, i32 6, ptr nonnull @_QQclXef2a3d277f21696c502d88d66b82bd8a, i32 1123)
  br label %.sink.split314

186:                                              ; preds = %182
  %187 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX282720526573756C7420766572696669636174696F6E206661696C65642729, i64 31, ptr null, i32 6, ptr nonnull @_QQclXef2a3d277f21696c502d88d66b82bd8a, i32 1126)
  br label %.sink.split314

.sink.split314:                                   ; preds = %186, %184
  %.sink315 = phi ptr [ %185, %184 ], [ %187, %186 ]
  %188 = tail call i32 @_FortranAioEndIoStatement(ptr %.sink315)
  br label %189

189:                                              ; preds = %.sink.split314, %.loopexit
  %190 = tail call ptr @_FortranAioBeginExternalListOutput(i32 6, ptr nonnull @_QQclXef2a3d277f21696c502d88d66b82bd8a, i32 1130)
  %191 = tail call i1 @_FortranAioOutputAscii(ptr %190, ptr nonnull @_QQclX636C617373203D20, i64 8)
  %192 = tail call i1 @_FortranAioOutputAscii(ptr %190, ptr nonnull %5, i64 1)
  %193 = tail call i32 @_FortranAioEndIoStatement(ptr %190)
  ret void
}
...
define internal void @.omp.reduction.func(ptr nocapture readonly %0, ptr nocapture readonly %1) #9 {
...
; Function Attrs: nounwind
declare !callback !316 void @__kmpc_fork_call(ptr, i32, ptr, ...) local_unnamed_addr #6
...
; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare <2 x double> @llvm.exp.v2f64(<2 x double>) #11

attributes #0 = { "target-cpu"="x86-64" }
attributes #1 = { nounwind "target-cpu"="x86-64" }
attributes #2 = { nofree norecurse nosync nounwind memory(write, argmem: read, inaccessiblemem: none) "target-cpu"="x86-64" }
attributes #3 = { nofree norecurse nosync nounwind memory(argmem: readwrite) "target-cpu"="x86-64" }
attributes #4 = { nofree norecurse nosync nounwind memory(argmem: read) "target-cpu"="x86-64" }
attributes #5 = { nofree }
