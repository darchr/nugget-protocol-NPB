...
$_QQclX1467dcb03b5d9cc14f28a7b63d346a29 = comdat any
...
@_QMft_dataECcompiletime = local_unnamed_addr constant [11 x i8] c"03 Dec 2024"
...
@_QQclX1467dcb03b5d9cc14f28a7b63d346a29 = linkonce constant [90 x i8] c"/home/studyztp/experiments/panning/hardware-experiment/nugget-protocol-NPB/FT/ft_data.f90\00", comdat
...
define void @alloc_space_() local_unnamed_addr #0 {
  ...
  %2 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMft_fieldsEu0, i1 true, ptr null, ptr nonnull @_QQclX1467dcb03b5d9cc14f28a7b63d346a29, i32 175)
  %3 = icmp eq i32 %2, 0
  br i1 %3, label %4, label %.critedge

4:                                                ; preds = %0
  %5 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMft_fieldsEpad1, i32 0, i64 1, i64 3)
  %6 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMft_fieldsEpad1, i1 true, ptr null, ptr nonnull @_QQclX1467dcb03b5d9cc14f28a7b63d346a29, i32 175)
  %7 = icmp eq i32 %6, 0
  br i1 %7, label %8, label %.critedge

8:                                                ; preds = %4
  %9 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMft_fieldsEu1, i32 0, i64 1, i64 2148532224)
  %10 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMft_fieldsEu1, i1 true, ptr null, ptr nonnull @_QQclX1467dcb03b5d9cc14f28a7b63d346a29, i32 175)
  %11 = icmp eq i32 %10, 0
  br i1 %11, label %12, label %.critedge

12:                                               ; preds = %8
  %13 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMft_fieldsEpad2, i32 0, i64 1, i64 3)
  %14 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMft_fieldsEpad2, i1 true, ptr null, ptr nonnull @_QQclX1467dcb03b5d9cc14f28a7b63d346a29, i32 175)
  %15 = icmp eq i32 %14, 0
  br i1 %15, label %16, label %.critedge

16:                                               ; preds = %12
  %17 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMft_fieldsEtwiddle, i32 0, i64 1, i64 2148532224)
  %18 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMft_fieldsEtwiddle, i1 true, ptr null, ptr nonnull @_QQclX1467dcb03b5d9cc14f28a7b63d346a29, i32 175)
  %19 = icmp eq i32 %18, 0
  br i1 %19, label %24, label %.critedge

.critedge:                                        ; preds = %12, %8, %4, %0, %16
  %20 = tail call ptr @_FortranAioBeginExternalListOutput(i32 6, ptr nonnull @_QQclX1467dcb03b5d9cc14f28a7b63d346a29, i32 183)
...
define void @free_space_() local_unnamed_addr #0 {
  %1 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMft_fieldsEu0, i1 true, ptr null, ptr nonnull @_QQclX1467dcb03b5d9cc14f28a7b63d346a29, i32 208)
  %2 = icmp eq i32 %1, 0
  br i1 %2, label %3, label %14

3:                                                ; preds = %0
  %4 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMft_fieldsEpad1, i1 true, ptr null, ptr nonnull @_QQclX1467dcb03b5d9cc14f28a7b63d346a29, i32 208)
  %5 = icmp eq i32 %4, 0
  br i1 %5, label %6, label %14

6:                                                ; preds = %3
  %7 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMft_fieldsEu1, i1 true, ptr null, ptr nonnull @_QQclX1467dcb03b5d9cc14f28a7b63d346a29, i32 208)
  %8 = icmp eq i32 %7, 0
  br i1 %8, label %9, label %14

9:                                                ; preds = %6
  %10 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMft_fieldsEpad2, i1 true, ptr null, ptr nonnull @_QQclX1467dcb03b5d9cc14f28a7b63d346a29, i32 208)
  %11 = icmp eq i32 %10, 0
  br i1 %11, label %12, label %14

12:                                               ; preds = %9
  %13 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMft_fieldsEtwiddle, i1 true, ptr null, ptr nonnull @_QQclX1467dcb03b5d9cc14f28a7b63d346a29, i32 208)
  br label %14
