...
$_QQclX2b09f6d3c447cb234e7ad58b847b4463 = comdat any
...
@_QMcg_dataECcompiletime = local_unnamed_addr constant [11 x i8] c"03 Dec 2024"
...
@_QQclX2b09f6d3c447cb234e7ad58b847b4463 = linkonce constant [90 x i8] c"/home/studyztp/experiments/panning/hardware-experiment/nugget-protocol-NPB/CG/cg_data.f90\00", comdat
...
define void @alloc_space_() local_unnamed_addr #0 {
  ...
  %4 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMcg_dataEcolidx, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 100)
  %5 = icmp eq i32 %4, 0
  br i1 %5, label %6, label %.critedge

6:                                                ; preds = %0
  %7 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataErowstr, i32 0, i64 1, i64 14001)
  %8 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMcg_dataErowstr, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 100)
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %10, label %.critedge

10:                                               ; preds = %6
  %11 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEiv, i32 0, i64 1, i64 2030000)
  %12 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMcg_dataEiv, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 100)
  %13 = icmp eq i32 %12, 0
  br i1 %13, label %14, label %.critedge

14:                                               ; preds = %10
  %15 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEarow, i32 0, i64 1, i64 14000)
  %16 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMcg_dataEarow, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 100)
  %17 = icmp eq i32 %16, 0
  br i1 %17, label %18, label %.critedge

18:                                               ; preds = %14
  %19 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEacol, i32 0, i64 1, i64 168000)
  %20 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMcg_dataEacol, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 100)
  %21 = icmp eq i32 %20, 0
  br i1 %21, label %22, label %.critedge

22:                                               ; preds = %18
  %23 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEv, i32 0, i64 1, i64 2016000)
  %24 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMcg_dataEv, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 100)
  %25 = icmp eq i32 %24, 0
  br i1 %25, label %26, label %.critedge

26:                                               ; preds = %22
  %27 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEaelt, i32 0, i64 1, i64 168000)
  %28 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMcg_dataEaelt, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 100)
  %29 = icmp eq i32 %28, 0
  br i1 %29, label %30, label %.critedge

30:                                               ; preds = %26
  %31 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEa, i32 0, i64 1, i64 2016000)
  %32 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMcg_dataEa, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 100)
  %33 = icmp eq i32 %32, 0
  br i1 %33, label %34, label %.critedge

34:                                               ; preds = %30
  %35 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEx, i32 0, i64 1, i64 14002)
  %36 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMcg_dataEx, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 100)
  %37 = icmp eq i32 %36, 0
  br i1 %37, label %38, label %.critedge

38:                                               ; preds = %34
  %39 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEz, i32 0, i64 1, i64 14002)
  %40 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMcg_dataEz, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 100)
  %41 = icmp eq i32 %40, 0
  br i1 %41, label %42, label %.critedge

42:                                               ; preds = %38
  %43 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEp, i32 0, i64 1, i64 14002)
  %44 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMcg_dataEp, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 100)
  %45 = icmp eq i32 %44, 0
  br i1 %45, label %46, label %.critedge

46:                                               ; preds = %42
  %47 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEq, i32 0, i64 1, i64 14002)
  %48 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMcg_dataEq, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 100)
  %49 = icmp eq i32 %48, 0
  br i1 %49, label %50, label %.critedge

50:                                               ; preds = %46
  %51 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEr, i32 0, i64 1, i64 14002)
  %52 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMcg_dataEr, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 100)
  %53 = icmp eq i32 %52, 0
  br i1 %53, label %58, label %.critedge

.critedge:                                        ; preds = %46, %42, %38, %34, %30, %26, %22, %18, %14, %10, %6, %0, %50
  %54 = tail call ptr @_FortranAioBeginExternalListOutput(i32 6, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 112)
...
define void @free_space_() local_unnamed_addr #0 {
  ...
  %1 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num1, ptr nonnull @_QMcg_dataEamult, i64 8, ptr nonnull @_QMcg_dataEamult.cache)
  %2 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num1, ptr nonnull @_QMcg_dataEtran, i64 8, ptr nonnull @_QMcg_dataEtran.cache)
  %3 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMcg_dataEcolidx, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 136)
  %4 = icmp eq i32 %3, 0
  br i1 %4, label %5, label %40

5:                                                ; preds = %0
  %6 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMcg_dataErowstr, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 136)
  %7 = icmp eq i32 %6, 0
  br i1 %7, label %8, label %40

8:                                                ; preds = %5
  %9 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMcg_dataEiv, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 136)
  %10 = icmp eq i32 %9, 0
  br i1 %10, label %11, label %40

11:                                               ; preds = %8
  %12 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMcg_dataEarow, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 136)
  %13 = icmp eq i32 %12, 0
  br i1 %13, label %14, label %40

14:                                               ; preds = %11
  %15 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMcg_dataEacol, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 136)
  %16 = icmp eq i32 %15, 0
  br i1 %16, label %17, label %40

17:                                               ; preds = %14
  %18 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMcg_dataEv, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 136)
  %19 = icmp eq i32 %18, 0
  br i1 %19, label %20, label %40

20:                                               ; preds = %17
  %21 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMcg_dataEaelt, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 136)
  %22 = icmp eq i32 %21, 0
  br i1 %22, label %23, label %40

23:                                               ; preds = %20
  %24 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMcg_dataEa, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 136)
  %25 = icmp eq i32 %24, 0
  br i1 %25, label %26, label %40

26:                                               ; preds = %23
  %27 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMcg_dataEx, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 136)
  %28 = icmp eq i32 %27, 0
  br i1 %28, label %29, label %40

29:                                               ; preds = %26
  %30 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMcg_dataEz, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 136)
  %31 = icmp eq i32 %30, 0
  br i1 %31, label %32, label %40

32:                                               ; preds = %29
  %33 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMcg_dataEp, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 136)
  %34 = icmp eq i32 %33, 0
  br i1 %34, label %35, label %40

35:                                               ; preds = %32
  %36 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMcg_dataEq, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 136)
  %37 = icmp eq i32 %36, 0
  br i1 %37, label %38, label %40

38:                                               ; preds = %35
  %39 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMcg_dataEr, i1 true, ptr null, ptr nonnull @_QQclX2b09f6d3c447cb234e7ad58b847b4463, i32 136)
  br label %40
