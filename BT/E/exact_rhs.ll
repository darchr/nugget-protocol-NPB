...
omp_collapsed.body131:                            ; preds = %omp_collapsed.body131.lr.ph, %omp.wsloop.region125.preheader
  ...
  %928 = urem i32 %927, %omp_loop.tripcount91
  %929 = udiv i32 %927, %omp_loop.tripcount91
  %930 = add i32 %929, 1
...
omp_collapsed.body74:                             ; preds = %omp_collapsed.body74.lr.ph, %omp.wsloop.region68.preheader
  ...
  %1657 = urem i32 %1656, %omp_loop.tripcount34
  %1658 = udiv i32 %1656, %omp_loop.tripcount34
  %1659 = add i32 %1658, 1
