...
$_QQclXa354e18391c29447ccac3dd878bf4696 = comdat any
...
@_QMbt_dataECcompiletime = local_unnamed_addr constant [11 x i8] c"03 Dec 2024"
...
@_QQclXa354e18391c29447ccac3dd878bf4696 = linkonce constant [90 x i8] c"/home/studyztp/experiments/panning/hardware-experiment/nugget-protocol-NPB/BT/bt_data.f90\00", comdat
...
define void @alloc_space_() local_unnamed_addr #0 {
  ...
  %8 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMbt_dataEus, i1 true, ptr null, ptr nonnull @_QQclXa354e18391c29447ccac3dd878bf4696, i32 113)
  %9 = icmp eq i32 %8, 0
...
10:                                               ; preds = %0
  ...
  %14 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMbt_dataEvs, i1 true, ptr null, ptr nonnull @_QQclXa354e18391c29447ccac3dd878bf4696, i32 113)
  %15 = icmp eq i32 %14, 0
...
16:                                               ; preds = %10
  ...
  %20 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMbt_dataEws, i1 true, ptr null, ptr nonnull @_QQclXa354e18391c29447ccac3dd878bf4696, i32 113)
  %21 = icmp eq i32 %20, 0
...
22:                                               ; preds = %16
  ...
  %26 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMbt_dataEqs, i1 true, ptr null, ptr nonnull @_QQclXa354e18391c29447ccac3dd878bf4696, i32 113)
  %27 = icmp eq i32 %26, 0
...
28:                                               ; preds = %22
  ...
  %32 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMbt_dataErho_i, i1 true, ptr null, ptr nonnull @_QQclXa354e18391c29447ccac3dd878bf4696, i32 113)
  %33 = icmp eq i32 %32, 0
...
34:                                               ; preds = %28
  ...
  %38 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMbt_dataEsquare, i1 true, ptr null, ptr nonnull @_QQclXa354e18391c29447ccac3dd878bf4696, i32 113)
  %39 = icmp eq i32 %38, 0
...
40:                                               ; preds = %34
  ...
  %45 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMbt_dataEforcing, i1 true, ptr null, ptr nonnull @_QQclXa354e18391c29447ccac3dd878bf4696, i32 113)
  %46 = icmp eq i32 %45, 0
...
47:                                               ; preds = %40
  ...
  %52 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMbt_dataEu, i1 true, ptr null, ptr nonnull @_QQclXa354e18391c29447ccac3dd878bf4696, i32 113)
  %53 = icmp eq i32 %52, 0
...
54:                                               ; preds = %47
  ...
  %59 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMbt_dataErhs, i1 true, ptr null, ptr nonnull @_QQclXa354e18391c29447ccac3dd878bf4696, i32 113)
  %60 = icmp eq i32 %59, 0
  br i1 %60, label %65, label %.critedge

.critedge:                                        ; preds = %47, %40, %34, %28, %22, %16, %10, %0, %54
  %61 = tail call ptr @_FortranAioBeginExternalListOutput(i32 6, ptr nonnull @_QQclXa354e18391c29447ccac3dd878bf4696, i32 126)
...
define void @free_space_() local_unnamed_addr #0 {
  ...
  %3 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num3, ptr nonnull @_QMbt_dataEq, i64 1304, ptr nonnull @_QMbt_dataEq.cache)
  %4 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num3, ptr nonnull @_QMbt_dataEue, i64 6520, ptr nonnull @_QMbt_dataEue.cache)
  %5 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMbt_dataEus, i1 true, ptr null, ptr nonnull @_QQclXa354e18391c29447ccac3dd878bf4696, i32 150)
  %6 = icmp eq i32 %5, 0
  br i1 %6, label %7, label %30

7:                                                ; preds = %0
  %8 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMbt_dataEvs, i1 true, ptr null, ptr nonnull @_QQclXa354e18391c29447ccac3dd878bf4696, i32 150)
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %10, label %30

10:                                               ; preds = %7
  %11 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMbt_dataEws, i1 true, ptr null, ptr nonnull @_QQclXa354e18391c29447ccac3dd878bf4696, i32 150)
  %12 = icmp eq i32 %11, 0
  br i1 %12, label %13, label %30

13:                                               ; preds = %10
  %14 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMbt_dataEqs, i1 true, ptr null, ptr nonnull @_QQclXa354e18391c29447ccac3dd878bf4696, i32 150)
  %15 = icmp eq i32 %14, 0
  br i1 %15, label %16, label %30

16:                                               ; preds = %13
  %17 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMbt_dataErho_i, i1 true, ptr null, ptr nonnull @_QQclXa354e18391c29447ccac3dd878bf4696, i32 150)
  %18 = icmp eq i32 %17, 0
  br i1 %18, label %19, label %30

19:                                               ; preds = %16
  %20 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMbt_dataEsquare, i1 true, ptr null, ptr nonnull @_QQclXa354e18391c29447ccac3dd878bf4696, i32 150)
  %21 = icmp eq i32 %20, 0
  br i1 %21, label %22, label %30

22:                                               ; preds = %19
  %23 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMbt_dataEforcing, i1 true, ptr null, ptr nonnull @_QQclXa354e18391c29447ccac3dd878bf4696, i32 150)
  %24 = icmp eq i32 %23, 0
  br i1 %24, label %25, label %30

25:                                               ; preds = %22
  %26 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMbt_dataEu, i1 true, ptr null, ptr nonnull @_QQclXa354e18391c29447ccac3dd878bf4696, i32 150)
  %27 = icmp eq i32 %26, 0
  br i1 %27, label %28, label %30

28:                                               ; preds = %25
  %29 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMbt_dataErhs, i1 true, ptr null, ptr nonnull @_QQclXa354e18391c29447ccac3dd878bf4696, i32 150)
  br label %30
