...
def main():
    cores = [i for i in range(10) if i%2 == 0]
    ...
    env["LD_LIBRARY_PATH"] = "/usr/lib/llvm-18/lib/x86_64-unknown-linux-gnu;"
    ...
    workdir = Path().cwd()
    runs_range = (0, 5)
    experiments_dir = Path(workdir/f"experiments/{num_threads}-thread-papi-nuggets/crystal-experiments")
