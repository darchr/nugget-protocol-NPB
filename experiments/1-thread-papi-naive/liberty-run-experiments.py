...
def main():
    ...
    workdir = Path().cwd()
    runs_range = (0, 5)
    experiments_dir = Path(workdir/f"experiments/{num_threads}-thread-papi-naive/liberty-experiments")
    ...
    for benchmark in benchmarks:
        ...
        benchmark_binary = Path(workdir/f"cbuild/llvm-exec/{num_threads}_thread_papi_naive_{opt_level}_exe_{benchmark}/{num_threads}_thread_papi_naive_{opt_level}_exe_{benchmark}")
