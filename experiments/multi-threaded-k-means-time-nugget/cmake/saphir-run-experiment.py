...
def main():
    ...
    workdir = Path().cwd()
    runs_range = (0, 5)
    experiments_dir = Path(workdir/"experiments/time-nuggets-experiments_0_9/experiments")
    ...
    for benchmark in benchmarks:
        ...
        for rid in all_benchmark_rids:
            ...
            benchmark_binary = Path(workdir/f"cbuild/llvm-exec/papi_nugget_0_9_exe_{benchmark}_{rid}/papi_nugget_0_9_exe_{benchmark}_{rid}")
