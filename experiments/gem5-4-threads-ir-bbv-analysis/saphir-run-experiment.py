...
def main():
    cores = ["20_23", "24_27", "28_31", "32_35", "36_39", "40_43", "44_47", 
             "48_51", "52_55", "56_59", "60_63", "64_67"]
    
    targeted_num_threads = 4 
    ...
    env = os.environ.copy()
    env["OMP_NUM_THREADS"] = str(targeted_num_threads)
    ...
    workdir = Path().cwd()
    runs_range = (0, 1)
    experiments_dir = Path(workdir/f"experiments/gem5-{targeted_num_threads}-threads-ir-bbv-analysis")
    ...
    for benchmark in benchmarks:
        ...
        benchmark_binary = Path(workdir/f"cbuild/llvm-exec/ir_bb_analysis_{targeted_num_threads}00000000_exe_{benchmark}/ir_bb_analysis_{targeted_num_threads}00000000_exe_{benchmark}")
