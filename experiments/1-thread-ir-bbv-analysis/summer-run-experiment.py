...
def main():
    ...
    workdir = Path().cwd()
    runs_range = (0, 1)
    experiments_dir = Path(workdir/"experiments/1-thread-ir-bbv-analysis/summer-experiments")
    ...
    for benchmark in benchmarks:
        ...
        benchmark_binary = Path(workdir/f"cbuild/llvm-exec/1_thread_ir_bb_analysis_exe_{benchmark}/1_thread_ir_bb_analysis_exe_{benchmark}")
    ...
    with open(experiments_dir / "summer_failed_list.txt", "w") as failed_list_file:
