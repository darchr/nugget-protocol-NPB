...
output_dir = Path(root_path/f"experiments/4-threads-info/create-markers/{grace_perc}")
...
k_means_clustering_dir = Path(f"{root_path}/experiments/4-threads-info/k-means-selections")
random_selections_dir = Path(f"{root_path}/experiments/4-threads-info/random-selections")
