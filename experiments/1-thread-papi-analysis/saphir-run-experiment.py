...
def main():
    cores = ["18", "20", "22", "24", "26", "28", "30", "32", "34", "36", "38", "40", "42", "44", "46", "48",
    ...
    workdir = Path().cwd()
    runs_range = (0, 1)
    experiments_dir = Path(workdir/"experiments/1-thread-papi-analysis/experiments")
    ...
    for benchmark in benchmarks:
        ...
        benchmark_binary = Path(workdir/f"cbuild/llvm-exec/papi_analysis_exe_{benchmark}/papi_analysis_exe_{benchmark}")
