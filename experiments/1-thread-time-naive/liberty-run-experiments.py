...
def main():
    ...
    for benchmark in benchmarks:
        ...
        benchmark_binary = Path(workdir/f"cbuild/llvm-exec/{num_threads}_thread_time_naive_{opt_level}_exe_{benchmark}/{num_threads}_thread_time_naive_{opt_level}_exe_{benchmark}")
