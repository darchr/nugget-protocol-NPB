...
def get_all_runs(dir):
    ...
    for run in dir.iterdir():
        ...
        run_result_file_path = Path(run/"result.txt")

        if not run_result_file_path.exists():
            failed_list.append(run_result_file_path.as_posix())
        else:
            run_result = read_data(run_result_file_path)
...
output_dir = Path("/home/studyztp/test_ground/experiments/nugget-gem5/nugget-protocol-NPB/experiments/4-threads-analysis/nugget-data")
data_dir = Path("/home/studyztp/test_ground/experiments/nugget-gem5/nugget-protocol-NPB/experiments/gem5-4-threads-time-nuggets")
