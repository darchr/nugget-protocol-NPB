...
workdir = Path().cwd()
k_means_selection_data_dir = Path(workdir/f"experiments/4-threads-info/k-means-selections")
naive_data_df_path = Path(workdir/f"experiments/4-threads-analysis/papi-naive/naive_data.csv")
nugget_data_df_path = Path(workdir/f"experiments/4-threads-analysis/nugget-data/nugget_data.csv")
...
final_data_df.to_csv(Path(workdir/f"experiments/4-threads-analysis/k-means-accuracy/k-means-accuracy.csv"), index=False)
