...
@key_array = dso_local local_unnamed_addr global [2147483648 x i64] zeroinitializer, align 16
@key_buff1 = dso_local global [134217728 x i64] zeroinitializer, align 16
@key_buff2 = dso_local global [2147483648 x i64] zeroinitializer, align 16
...
define internal void @alloc_key_buff.omp_outlined(ptr noalias nocapture noundef readonly %0, ptr noalias nocapture readnone %1) #4 {
  ...
  store i64 2147483647, ptr %4, align 8, !tbaa !15
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %5) #6
...
define internal void @full_verify.omp_outlined.1(ptr noalias nocapture noundef readonly %0, ptr noalias nocapture readnone %1, ptr nocapture noundef nonnull align 8 dereferenceable(8) %2) #4 {
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %5) #6
  store i64 2147483646, ptr %5, align 8, !tbaa !15
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %6) #6
...
define dso_local void @rank(i32 noundef %0) local_unnamed_addr #3 {
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %5) #6
  store i64 131072, ptr %5, align 8, !tbaa !15
  %6 = sext i32 %0 to i64
  ...
  %27 = load i64, ptr @partial_verify_vals, align 16, !tbaa !15
  %28 = add i64 %27, -1
...
30:                                               ; preds = %1
  ...
  %35 = load i64, ptr @test_rank_array, align 16, !tbaa !15
  %36 = add i64 %35, %6
  %37 = icmp eq i64 %34, %36
  br i1 %37, label %38, label %41

38:                                               ; preds = %30
  %39 = load i32, ptr @passed_verification, align 4, !tbaa !6
  %40 = add nsw i32 %39, 1
  store i32 %40, ptr @passed_verification, align 4, !tbaa !6
  br label %43
...
43:                                               ; preds = %38, %41, %1
  %44 = load i64, ptr getelementptr inbounds ([5 x i64], ptr @partial_verify_vals, i64 0, i64 1), align 8, !tbaa !15
  %45 = add i64 %44, -1
...
47:                                               ; preds = %43
  ...
  %52 = load i64, ptr getelementptr inbounds ([5 x i64], ptr @test_rank_array, i64 0, i64 1), align 8, !tbaa !15
  %53 = add i64 %52, %6
...
57:                                               ; preds = %47
  %58 = load i32, ptr @passed_verification, align 4, !tbaa !6
  %59 = add nsw i32 %58, 1
  store i32 %59, ptr @passed_verification, align 4, !tbaa !6
  br label %60

60:                                               ; preds = %57, %55, %43
  %61 = load i64, ptr getelementptr inbounds ([5 x i64], ptr @partial_verify_vals, i64 0, i64 2), align 16, !tbaa !15
  %62 = add i64 %61, -1
...
64:                                               ; preds = %60
  ...
  %69 = load i64, ptr getelementptr inbounds ([5 x i64], ptr @test_rank_array, i64 0, i64 2), align 16, !tbaa !15
  %70 = sub i64 %69, %6
...
77:                                               ; preds = %74, %72, %60
  %78 = load i64, ptr getelementptr inbounds ([5 x i64], ptr @partial_verify_vals, i64 0, i64 3), align 8, !tbaa !15
  %79 = add i64 %78, -1
...
81:                                               ; preds = %77
  ...
  %86 = load i64, ptr getelementptr inbounds ([5 x i64], ptr @test_rank_array, i64 0, i64 3), align 8, !tbaa !15
  %87 = sub i64 %86, %6
...
91:                                               ; preds = %81
  %92 = load i32, ptr @passed_verification, align 4, !tbaa !6
  %93 = add nsw i32 %92, 1
  store i32 %93, ptr @passed_verification, align 4, !tbaa !6
  br label %94

94:                                               ; preds = %91, %89, %77
  %95 = load i64, ptr getelementptr inbounds ([5 x i64], ptr @partial_verify_vals, i64 0, i64 4), align 16, !tbaa !15
  %96 = add i64 %95, -1
...
98:                                               ; preds = %94
  ...
  %103 = load i64, ptr getelementptr inbounds ([5 x i64], ptr @test_rank_array, i64 0, i64 4), align 16, !tbaa !15
  %104 = sub i64 %103, %6
...
108:                                              ; preds = %98
  %109 = load i32, ptr @passed_verification, align 4, !tbaa !6
  %110 = add nsw i32 %109, 1
  store i32 %110, ptr @passed_verification, align 4, !tbaa !6
  br label %111
...
113:                                              ; preds = %111
  ...
  store ptr %114, ptr @key_buff_ptr_global, align 8, !tbaa !20
  br label %115
...
define internal void @rank.omp_outlined(ptr noalias nocapture noundef readonly %0, ptr noalias nocapture readnone %1, ptr nocapture noundef nonnull readonly align 4 dereferenceable(4) %2, ptr nocapture noundef nonnull readonly align 8 dereferenceable(8) %3, ptr nocapture noundef nonnull readonly align 8 dereferenceable(8) %4, ptr nocapture noundef nonnull readonly align 8 dereferenceable(8) %5) #4 {
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %8) #6
  store i64 2147483647, ptr %8, align 8, !tbaa !15
...
36:                                               ; preds = %30
  %37 = getelementptr inbounds [2147483648 x i64], ptr @key_array, i64 0, i64 %28
...
47:                                               ; preds = %44, %47
  ...
  %49 = getelementptr inbounds [2147483648 x i64], ptr @key_array, i64 0, i64 %48
  ...
  %55 = add nsw i64 %48, 1
  %56 = getelementptr inbounds [2147483648 x i64], ptr @key_array, i64 0, i64 %55
...
236:                                              ; preds = %232
  ...
  store i64 2147483647, ptr %12, align 8, !tbaa !15
...
244:                                              ; preds = %241, %244
  ...
  %246 = getelementptr inbounds [2147483648 x i64], ptr @key_array, i64 0, i64 %245
  ...
  %252 = getelementptr inbounds [2147483648 x i64], ptr @key_buff2, i64 0, i64 %250
...
11:                                               ; preds = %2
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(40) @test_index_array, ptr noundef nonnull align 16 dereferenceable(40) @D_test_index_array, i64 40, i1 false), !tbaa !15
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(40) @test_rank_array, ptr noundef nonnull align 16 dereferenceable(40) @D_test_rank_array, i64 40, i1 false), !tbaa !15
