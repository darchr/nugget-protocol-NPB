...
@key_buff1 = dso_local global [8388608 x i32] zeroinitializer, align 16
@key_buff2 = dso_local global [134217728 x i32] zeroinitializer, align 16
...
define internal void @alloc_key_buff.omp_outlined(ptr noalias nocapture noundef readonly %0, ptr noalias nocapture readnone %1) #4 {
  ...
  store i32 134217727, ptr %4, align 4, !tbaa !6
...
define internal void @full_verify.omp_outlined.1(ptr noalias nocapture noundef readonly %0, ptr noalias nocapture readnone %1, ptr nocapture noundef nonnull align 4 dereferenceable(4) %2) #4 {
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %5) #6
  store i32 134217726, ptr %5, align 4, !tbaa !6
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %6) #6
...
define dso_local void @rank(i32 noundef %0) local_unnamed_addr #3 {
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %5) #6
  store i32 8192, ptr %5, align 4, !tbaa !6
  %6 = sext i32 %0 to i64
...
define internal void @rank.omp_outlined(ptr noalias nocapture noundef readonly %0, ptr noalias nocapture readnone %1, ptr nocapture noundef nonnull readonly align 4 dereferenceable(4) %2, ptr nocapture noundef nonnull readonly align 4 dereferenceable(4) %3, ptr nocapture noundef nonnull readonly align 8 dereferenceable(8) %4, ptr nocapture noundef nonnull readonly align 8 dereferenceable(8) %5) #4 {
  ...
  store i32 0, ptr %7, align 4, !tbaa !6
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %8) #6
  store i32 134217727, ptr %8, align 4, !tbaa !6
...
219:                                              ; preds = %215
  ...
  store i32 134217727, ptr %12, align 4, !tbaa !6
  ...
  %221 = call i32 @llvm.smin.i32(i32 %220, i32 134217727)
...
226:                                              ; preds = %224, %226
  ...
  %228 = getelementptr inbounds [134217728 x i32], ptr @key_array, i64 0, i64 %227
  ...
  %237 = getelementptr inbounds [134217728 x i32], ptr @key_buff2, i64 0, i64 %236
...
11:                                               ; preds = %2
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(20) @test_index_array, ptr noundef nonnull align 16 dereferenceable(20) @C_test_index_array, i64 20, i1 false), !tbaa !6
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(20) @test_rank_array, ptr noundef nonnull align 16 dereferenceable(20) @C_test_rank_array, i64 20, i1 false), !tbaa !6
