...
omp_collapsed.body83:                             ; preds = %omp_collapsed.body83.preheader, %omp_collapsed.body83
  ...
  %54 = urem i32 %53, %omp_loop.tripcount64
  %55 = udiv i32 %53, %omp_loop.tripcount64
  %56 = add i32 %55, 1
...
omp_collapsed.body47:                             ; preds = %omp_collapsed.body47.preheader, %omp_collapsed.body47
  ...
  %104 = urem i32 %103, %omp_loop.tripcount28
  %105 = udiv i32 %103, %omp_loop.tripcount28
  %106 = add i32 %105, 1
...
omp_collapsed.body:                               ; preds = %omp_collapsed.body.preheader, %omp_collapsed.body
  ...
  %155 = urem i32 %154, %omp_loop.tripcount7
  %156 = udiv i32 %154, %omp_loop.tripcount7
  %157 = add i32 %156, 1
