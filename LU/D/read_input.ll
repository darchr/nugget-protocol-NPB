...
$_QQclX81326b042265287853247909859d58df = comdat any
...
@_QQclX81326b042265287853247909859d58df = linkonce constant [93 x i8] c"/home/studyztp/experiments/panning/hardware-experiment/nugget-protocol-NPB/LU/read_input.f90\00", comdat
...
define void @read_input_() local_unnamed_addr #0 {
  ...
  %6 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX745adf91374d56fb027f90d64de9ba3b, i64 66, ptr null, i32 6, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 29)
  %7 = tail call i32 @_FortranAioEndIoStatement(ptr %6)
  %8 = tail call ptr @_FortranAioBeginOpenUnit(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 31)
...
20:                                               ; preds = %17
  %21 = tail call ptr @_FortranAioBeginExternalListOutput(i32 6, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 35)
  ...
  %24 = tail call ptr @_FortranAioBeginExternalListInput(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 37)
  %25 = tail call i32 @_FortranAioEndIoStatement(ptr %24)
  %26 = tail call ptr @_FortranAioBeginExternalListInput(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 38)
  %27 = tail call i32 @_FortranAioEndIoStatement(ptr %26)
  %28 = tail call ptr @_FortranAioBeginExternalListInput(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 39)
  ...
  %32 = tail call ptr @_FortranAioBeginExternalListInput(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 40)
  %33 = tail call i32 @_FortranAioEndIoStatement(ptr %32)
  %34 = tail call ptr @_FortranAioBeginExternalListInput(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 41)
  %35 = tail call i32 @_FortranAioEndIoStatement(ptr %34)
  %36 = tail call ptr @_FortranAioBeginExternalListInput(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 42)
  ...
  %39 = tail call ptr @_FortranAioBeginExternalListInput(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 43)
  %40 = tail call i32 @_FortranAioEndIoStatement(ptr %39)
  %41 = tail call ptr @_FortranAioBeginExternalListInput(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 44)
  %42 = tail call i32 @_FortranAioEndIoStatement(ptr %41)
  %43 = tail call ptr @_FortranAioBeginExternalListInput(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 45)
  %44 = tail call i1 @_FortranAioInputReal64(ptr %43, ptr nonnull @_QMlu_dataEdt)
  %45 = tail call i32 @_FortranAioEndIoStatement(ptr %43)
  %46 = tail call ptr @_FortranAioBeginExternalListInput(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 46)
  %47 = tail call i32 @_FortranAioEndIoStatement(ptr %46)
  %48 = tail call ptr @_FortranAioBeginExternalListInput(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 47)
  %49 = tail call i32 @_FortranAioEndIoStatement(ptr %48)
  %50 = tail call ptr @_FortranAioBeginExternalListInput(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 48)
  ...
  %53 = tail call ptr @_FortranAioBeginExternalListInput(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 49)
  %54 = tail call i32 @_FortranAioEndIoStatement(ptr %53)
  %55 = tail call ptr @_FortranAioBeginExternalListInput(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 50)
  %56 = tail call i32 @_FortranAioEndIoStatement(ptr %55)
  %57 = tail call ptr @_FortranAioBeginExternalListInput(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 51)
  ...
  %64 = tail call ptr @_FortranAioBeginExternalListInput(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 52)
  %65 = tail call i32 @_FortranAioEndIoStatement(ptr %64)
  %66 = tail call ptr @_FortranAioBeginExternalListInput(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 53)
  %67 = tail call i32 @_FortranAioEndIoStatement(ptr %66)
  %68 = tail call ptr @_FortranAioBeginExternalListInput(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 54)
  ...
  %73 = tail call ptr @_FortranAioBeginClose(i32 3, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 55)
...
85:                                               ; preds = %76
  %86 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX1daffebab4e116d40ee7c3e518e8196d, i64 88, ptr null, i32 6, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 80)
...
95:                                               ; preds = %89
  %96 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX9d81dfeadacfdde07700e6c8a94839b3, i64 119, ptr null, i32 6, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 91)
  %97 = tail call i32 @_FortranAioEndIoStatement(ptr %96)
  %98 = tail call {} @_FortranAStopStatement(i32 0, i1 false, i1 false)
  unreachable

99:                                               ; preds = %89
  %100 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX925fa4f14c0e6e2492aa90cb8722cfb5, i64 33, ptr null, i32 6, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 100)
  ...
  %108 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX63f70da6b7cfde3fd15fbdfe6ad3cc9f, i64 38, ptr null, i32 6, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 101)
  ...
  %112 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXf923a2af02906180bfbdd179b9b5c308, i64 38, ptr null, i32 6, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 102)
  ...
  %116 = tail call ptr @_FortranAioBeginExternalListOutput(i32 6, ptr nonnull @_QQclX81326b042265287853247909859d58df, i32 103)
