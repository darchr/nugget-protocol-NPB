...
$_QQclXd8897b57581cab91fa895a89574d69a9 = comdat any
...
@_QQclXd8897b57581cab91fa895a89574d69a9 = linkonce constant [89 x i8] c"/home/studyztp/experiments/panning/hardware-experiment/nugget-protocol-NPB/LU/verify.f90\00", comdat
...
166:                                              ; preds = %.preheader66
  %167 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX24a72f89c95326424e5862f727553f10, i64 50, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 346)
  %168 = tail call i1 @_FortranAioOutputAscii(ptr %167, ptr nonnull %3, i64 1)
  %169 = tail call i32 @_FortranAioEndIoStatement(ptr %167)
  %170 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX58860793655ac9dbc0430b8863e3b1bd, i64 44, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 348)
...
178:                                              ; preds = %166
  store i8 %.unpack, ptr %3, align 1, !tbaa !10
  %179 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXe9495278c2e4384cf1395432a29c90c7, i64 53, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 353)
  %180 = tail call i1 @_FortranAioOutputReal64(ptr %179, double %.046.ph)
  br label %.sink.split

181:                                              ; preds = %.preheader66
  %182 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX282720556E6B6E6F776E20636C6173732729, i64 18, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 358)
  br label %.sink.split
...
186:                                              ; preds = %184
  %187 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXbcb23f864f3b8a6d88bc42954f8e5ad1, i64 40, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 364)
  br label %.preheader65

188:                                              ; preds = %184
  %189 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX282720524D532D6E6F726D73206F6620726573696475616C2729, i64 26, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 366)
  br label %.preheader65
...
194:                                              ; preds = %191
  %195 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX282720202020202020202020272C2069322C2032782C206532302E313329, i64 30, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 373)
...
205:                                              ; preds = %200
  %206 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX15eda9a92180dff258ff2c6aa304e1f8, i64 46, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 376)
...
216:                                              ; preds = %200
  store i32 0, ptr %4, align 4, !tbaa !11
  %217 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXfbb3d0534361f91f5803d2c3dfa4e169, i64 46, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 379)
...
231:                                              ; preds = %229
  %232 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXedd94963bb73957d2976ee6464bc08aa, i64 46, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 384)
  br label %.preheader

233:                                              ; preds = %229
  %234 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX282720524D532D6E6F726D73206F6620736F6C7574696F6E206572726F722729, i64 32, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 386)
  br label %.preheader
...
239:                                              ; preds = %236
  %240 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX282720202020202020202020272C2069322C2032782C206532302E313329, i64 30, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 393)
...
250:                                              ; preds = %245
  %251 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX15eda9a92180dff258ff2c6aa304e1f8, i64 46, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 396)
...
261:                                              ; preds = %245
  store i32 0, ptr %4, align 4, !tbaa !11
  %262 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXfbb3d0534361f91f5803d2c3dfa4e169, i64 46, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 399)
...
276:                                              ; preds = %274
  %277 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXce117a3bb388544a35c6fafcc085e52d, i64 35, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 408)
  br label %280

278:                                              ; preds = %274
  %279 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX2827205375726661636520696E74656772616C2729, i64 21, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 410)
  br label %280
...
284:                                              ; preds = %280
  %285 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX282720202020202020202020272C2034782C206532302E313329, i64 26, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 417)
...
292:                                              ; preds = %288
  %293 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXad3996733915139f17a4bd454c1ea077, i64 42, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 420)
...
298:                                              ; preds = %288
  store i32 0, ptr %4, align 4, !tbaa !11
  %299 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX131ac07a9971e7bbddf28fce017df850, i64 42, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 423)
...
308:                                              ; preds = %304
  %309 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXccb8c2b95738603d7bec24d2be9727b3, i64 33, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 433)
  %310 = tail call i32 @_FortranAioEndIoStatement(ptr %309)
  %311 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX2827204E6F20766572696669636174696F6E20706572666F726D65642729, i64 30, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 434)
  br label %318
...
314:                                              ; preds = %312
  %315 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX282720566572696669636174696F6E205375636365737366756C2729, i64 28, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 438)
  br label %318

316:                                              ; preds = %312
  %317 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX282720566572696669636174696F6E206661696C65642729, i64 24, ptr null, i32 6, ptr nonnull @_QQclXd8897b57581cab91fa895a89574d69a9, i32 441)
  br label %318
