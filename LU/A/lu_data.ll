...
$_QQclXdaf52427a8abde7df4855f759f088f48 = comdat any
...
@_QMlu_dataECcompiletime = local_unnamed_addr constant [11 x i8] c"03 Dec 2024"
...
@_QQclXdaf52427a8abde7df4855f759f088f48 = linkonce constant [90 x i8] c"/home/studyztp/experiments/panning/hardware-experiment/nugget-protocol-NPB/LU/lu_data.f90\00", comdat
...
define void @alloc_space_() local_unnamed_addr #0 {
  ...
  %10 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMlu_dataEu, i1 true, ptr null, ptr nonnull @_QQclXdaf52427a8abde7df4855f759f088f48, i32 153)
  %11 = icmp eq i32 %10, 0
...
12:                                               ; preds = %0
  ...
  %17 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMlu_dataErsd, i1 true, ptr null, ptr nonnull @_QQclXdaf52427a8abde7df4855f759f088f48, i32 153)
  %18 = icmp eq i32 %17, 0
...
19:                                               ; preds = %12
  ...
  %24 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMlu_dataEfrct, i1 true, ptr null, ptr nonnull @_QQclXdaf52427a8abde7df4855f759f088f48, i32 153)
  %25 = icmp eq i32 %24, 0
...
26:                                               ; preds = %19
  ...
  %30 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMlu_dataEqs, i1 true, ptr null, ptr nonnull @_QQclXdaf52427a8abde7df4855f759f088f48, i32 153)
  %31 = icmp eq i32 %30, 0
...
32:                                               ; preds = %26
  ...
  %36 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMlu_dataErho_i, i1 true, ptr null, ptr nonnull @_QQclXdaf52427a8abde7df4855f759f088f48, i32 153)
  %37 = icmp eq i32 %36, 0
...
38:                                               ; preds = %32
  ...
  %41 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMlu_dataEphi1, i1 true, ptr null, ptr nonnull @_QQclXdaf52427a8abde7df4855f759f088f48, i32 153)
  %42 = icmp eq i32 %41, 0
...
43:                                               ; preds = %38
  ...
  %46 = tail call i32 @_FortranAAllocatableAllocate(ptr nonnull @_QMlu_dataEphi2, i1 true, ptr null, ptr nonnull @_QQclXdaf52427a8abde7df4855f759f088f48, i32 153)
  %47 = icmp eq i32 %46, 0
  br i1 %47, label %52, label %.critedge

.critedge:                                        ; preds = %38, %32, %26, %19, %12, %0, %43
  %48 = tail call ptr @_FortranAioBeginExternalListOutput(i32 6, ptr nonnull @_QQclXdaf52427a8abde7df4855f759f088f48, i32 164)
...
define void @free_space_() local_unnamed_addr #0 {
  ...
  %4 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num4, ptr nonnull @_QMlu_dataEd, i64 12800, ptr nonnull @_QMlu_dataEd.cache)
  %5 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num4, ptr nonnull @_QMlu_dataEflux, i64 2560, ptr nonnull @_QMlu_dataEflux.cache)
  %6 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMlu_dataEu, i1 true, ptr null, ptr nonnull @_QQclXdaf52427a8abde7df4855f759f088f48, i32 188)
  %7 = icmp eq i32 %6, 0
  br i1 %7, label %8, label %25

8:                                                ; preds = %0
  %9 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMlu_dataErsd, i1 true, ptr null, ptr nonnull @_QQclXdaf52427a8abde7df4855f759f088f48, i32 188)
  %10 = icmp eq i32 %9, 0
  br i1 %10, label %11, label %25

11:                                               ; preds = %8
  %12 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMlu_dataEfrct, i1 true, ptr null, ptr nonnull @_QQclXdaf52427a8abde7df4855f759f088f48, i32 188)
  %13 = icmp eq i32 %12, 0
  br i1 %13, label %14, label %25

14:                                               ; preds = %11
  %15 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMlu_dataEqs, i1 true, ptr null, ptr nonnull @_QQclXdaf52427a8abde7df4855f759f088f48, i32 188)
  %16 = icmp eq i32 %15, 0
  br i1 %16, label %17, label %25

17:                                               ; preds = %14
  %18 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMlu_dataErho_i, i1 true, ptr null, ptr nonnull @_QQclXdaf52427a8abde7df4855f759f088f48, i32 188)
  %19 = icmp eq i32 %18, 0
  br i1 %19, label %20, label %25

20:                                               ; preds = %17
  %21 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMlu_dataEphi1, i1 true, ptr null, ptr nonnull @_QQclXdaf52427a8abde7df4855f759f088f48, i32 188)
  %22 = icmp eq i32 %21, 0
  br i1 %22, label %23, label %25

23:                                               ; preds = %20
  %24 = tail call i32 @_FortranAAllocatableDeallocate(ptr nonnull @_QMlu_dataEphi2, i1 true, ptr null, ptr nonnull @_QQclXdaf52427a8abde7df4855f759f088f48, i32 188)
  br label %25
