...
$_QQclXbd1690d8ac0c3ad288695dc2905753c5 = comdat any
...
@_QQclXbd1690d8ac0c3ad288695dc2905753c5 = linkonce constant [87 x i8] c"/home/studyztp/experiments/panning/hardware-experiment/nugget-protocol-NPB/LU/ssor.f90\00", comdat
...
80:                                               ; preds = %.lr.ph.preheader
  %81 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX28272054696D65207374657020272C20693429, i64 19, ptr null, i32 6, ptr nonnull @_QQclXbd1690d8ac0c3ad288695dc2905753c5, i32 70)
...
134:                                              ; preds = %131
  %135 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX28272054696D65207374657020272C20693429, i64 19, ptr null, i32 6, ptr nonnull @_QQclXbd1690d8ac0c3ad288695dc2905753c5, i32 70)
...
.loopexit316:                                     ; preds = %160, %106
  ...
  %180 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXf29500b12f6bbc4f2324e21aad40d9c3, i64 66, ptr null, i32 6, ptr nonnull @_QQclXbd1690d8ac0c3ad288695dc2905753c5, i32 237)
...
omp_collapsed.body101.us:                         ; preds = %omp_collapsed.body101.us.preheader, %omp.wsloop.region92.omp.wsloop.region97_crit_edge.us
  ...
  %150 = urem i32 %149, %124
  %151 = udiv i32 %149, %124
  %152 = add i32 %151, 2
  %153 = add i32 %150, %118
