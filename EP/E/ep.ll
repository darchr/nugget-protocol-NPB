...
$_QQclX1d33eccdb020d77712e493c12de09214 = comdat any
...
@_QQclX1d33eccdb020d77712e493c12de09214 = linkonce constant [85 x i8] c"/home/studyztp/experiments/panning/hardware-experiment/nugget-protocol-NPB/EP/ep.f90\00", comdat
...
omp_parallel:
  ...
  %41 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX93686fb5f30bba826074b9969f476d62, i64 66, ptr null, i32 6, ptr nonnull @_QQclX1d33eccdb020d77712e493c12de09214, i32 80)
  %42 = call i32 @_FortranAioEndIoStatement(ptr %41)
  %43 = call ptr @_FortranAioBeginInternalFormattedOutput(ptr nonnull %33, i64 15, ptr nonnull @_QQclX286631352E3029, i64 7, ptr null, ptr null, i64 0, ptr nonnull @_QQclX1d33eccdb020d77712e493c12de09214, i32 81)
  ...
  %49 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX4e4e649b96200f41b28127b1c4f7ba25, i64 46, ptr null, i32 6, ptr nonnull @_QQclX1d33eccdb020d77712e493c12de09214, i32 84)
  %50 = call i1 @_FortranAioOutputAscii(ptr %49, ptr nonnull %33, i64 %spec.select)
  %51 = call i32 @_FortranAioEndIoStatement(ptr %49)
  %52 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX1dba85e7a8e5f1ae47438052d22db569, i64 49, ptr null, i32 6, ptr nonnull @_QQclX1d33eccdb020d77712e493c12de09214, i32 85)
  ...
  %56 = call ptr @_FortranAioBeginExternalListOutput(i32 6, ptr nonnull @_QQclX1d33eccdb020d77712e493c12de09214, i32 86)
  ...
  %100 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXc5c37bc6b99903bb8146235474aa39be, i64 133, ptr null, i32 6, ptr nonnull @_QQclX1d33eccdb020d77712e493c12de09214, i32 226)
  ...
  store i8 %.unpack, ptr %16, align 1, !tbaa !4
  store i32 41, ptr %15, align 4, !tbaa !4
  store i32 0, ptr %14, align 4, !tbaa !4
  store i32 0, ptr %13, align 4, !tbaa !4
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(24) %12, ptr noundef nonnull align 1 dereferenceable(24) @_QQclX52616E646F6D206E756D626572732067656E657261746564, i64 24, i1 false)
...
146:                                              ; preds = %145, %142
  ...
  %148 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX2831782C612C66392E332C272028272C66362E322C2725292729, i64 26, ptr null, i32 6, ptr nonnull @_QQclX1d33eccdb020d77712e493c12de09214, i32 241)
  ...
  %157 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX2831782C612C66392E332C272028272C66362E322C2725292729, i64 26, ptr null, i32 6, ptr nonnull @_QQclX1d33eccdb020d77712e493c12de09214, i32 243)
  ...
  %166 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX2831782C612C66392E332C272028272C66362E322C2725292729, i64 26, ptr null, i32 6, ptr nonnull @_QQclX1d33eccdb020d77712e493c12de09214, i32 245)
...
vector.body:                                      ; preds = %vector.body, %omp.par.entry
  %index = phi i64 [ 0, %omp.par.entry ], [ %index.next.3, %vector.body ]
  ...
  %offset.idx.1 = or disjoint i64 %index, 5
  %7 = getelementptr double, ptr %invariant.gep, i64 %offset.idx.1
  %8 = getelementptr i8, ptr %7, i64 16
  store <2 x double> <double 0xD47D42AEA2879F2E, double 0xD47D42AEA2879F2E>, ptr %7, align 8, !tbaa !4
  store <2 x double> <double 0xD47D42AEA2879F2E, double 0xD47D42AEA2879F2E>, ptr %8, align 8, !tbaa !4
  %offset.idx.2 = or disjoint i64 %index, 9
  %9 = getelementptr double, ptr %invariant.gep, i64 %offset.idx.2
  %10 = getelementptr i8, ptr %9, i64 16
  store <2 x double> <double 0xD47D42AEA2879F2E, double 0xD47D42AEA2879F2E>, ptr %9, align 8, !tbaa !4
  store <2 x double> <double 0xD47D42AEA2879F2E, double 0xD47D42AEA2879F2E>, ptr %10, align 8, !tbaa !4
  %offset.idx.3 = or disjoint i64 %index, 13
  %11 = getelementptr double, ptr %invariant.gep, i64 %offset.idx.3
  %12 = getelementptr i8, ptr %11, i64 16
  store <2 x double> <double 0xD47D42AEA2879F2E, double 0xD47D42AEA2879F2E>, ptr %11, align 8, !tbaa !4
  store <2 x double> <double 0xD47D42AEA2879F2E, double 0xD47D42AEA2879F2E>, ptr %12, align 8, !tbaa !4
  %index.next.3 = add nuw nsw i64 %index, 16
  %13 = icmp eq i64 %index.next.3, 131072
  br i1 %13, label %omp.par.region6, label %vector.body, !llvm.loop !20

omp.par.region6:                                  ; preds = %vector.body
  store i32 1, ptr %3, align 4, !tbaa !4
  call void @timer_clear_(ptr nonnull %3) #2
  %14 = load i32, ptr %loadgep_, align 4, !tbaa !4
